...
?>
   <thead>
     <tr>
<th id="" style="text-align:left;font-size:14px;width:200px;background-color:#fff;" ><b>Banquet Name</b></th>
<?php 
for($i=0;$i<7;$i++){
$dateE = date('d-m-Y', strtotime('+'.$i.'days', strtotime($dtee)));
?>
<th id="" style="font-size:14px;background-color:#fff;"><b><?php echo $dateE; ?></b></th>
<?php } ?>
</tr>
    </thead>
    <tbody>
