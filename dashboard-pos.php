...
?>
        <div class="wrapper ">
		  ...
		  <div style="font-size:15px;color:#7B0E0E;font-weight:bold;padding:6px;">Today's Status</div>
		  <ul>
		...
		<li><a href="#"></a></li>
			...
			<ul>
			<li><a href="#">Expected Departure <span style="font-size:15px;color:blue;"></span></a>
				<ul>
			...
			<li><a href="#">Today's Arrival <span style="font-size:15px;color:blue;"></span></a>
				<ul>
			...
			<ul>
			<li><a href="#">Today's Departure <span style="font-size:15px;color:blue;"></span></a>
				<ul>
...
<!--<img src="<?php echo $home_path;?>/images/admin2.png" style="width:20px;height:20px;float:left;margin:10px 3px 0 9px;" /><span style="float:left;font:bold 12px/1.5em Arial,Helvetica,sans-serif;margin:10px 3px 0 9px;"></span>-->
</div>
