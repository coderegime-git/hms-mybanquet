...
<li>gradient can be used as an images mask (custom mPDF styles: gradient-mask)</li>
<li>CSS3 images-orientation supported for &lt;IMG&gt; (similar to existing custom mPDF attribute: rotate)</li>
<li>CSS3 images-resolution supported for &lt;IMG&gt;</li>
<li>background-images-resolution (custom mPDF CSS-type style) to define resolution of background images</li>
<li>improved support for SVG images</li>
<li>SVG and WMF images supported in background-images</li>
