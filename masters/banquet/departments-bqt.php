...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#departmentForm').attr('action', '../../action/add_department_bqt.php');  
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        ...
        <form id="departmentForm" name="departmentForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_department_bqt.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="dept_code" id="dept_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" onblur="checkDepartmentCode();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="dept_name" id="dept_name" data-validation-engine="validate[required]" class="mypay-input validate[required]" onblur="checkDepartmentName();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
