		...
		<div>
			...
			<tbody>
				...
				<tr>
					...
					<tr>
						<td width="" valign="top"><label>Round Off<em>*</em></label></td>
					...
					<tr>
						<td width="" valign="top"><label>Rounded Amount</label></td>
						<td valign="top"><input name="address2" id="address2" type="text" class="textbox fstChUPPRCase" style="width:210px" /></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>Kot Auto Generate  <em>*</em></label></td>
						<td width="" valign="top"><input name="city" id="city" type="checkbox" data-validation="required" class="input validate[required] textbox fstChUPPRCase" style="width:87px"/></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>KOT Prefix</label></td>
						<td valign="top"><input name="address2" id="address2" type="text" class="textbox fstChUPPRCase" style="width:210px" /></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>Bill Prefix</label></td>
						<td valign="top"><input name="address2" id="address2" type="text" class="textbox fstChUPPRCase" style="width:210px" /></td>
			...
			<table style="width:50%;margin:4px 0 0 0;" class="table">
					<tbody>
					<tr>
					<td width="" valign="top"><label>Outlet Type <em>*</em></label></td>
					...
					<tr>
					<td width="" valign="top"><label>Bill Program ID<em>*</em></label></td>
					<td valign="top"><input name="phone" id="phone" type="text" data-validation="required" class="input validate[required,custom[integer]] textbox fstChUPPRCase" style="width:210px"/></td>
					</tr>
<tr>
					<td width="" valign="top"><label>Kot Print Port<em>*</em></label></td>
					<td valign="top"><input name="phone" id="phone" type="text" data-validation="required" class="input validate[required,custom[integer]] textbox fstChUPPRCase" style="width:210px"/></td>
					</tr>
<tr>
					<td width="" valign="top"><label>Bill Print Port<em>*</em></label></td>
					<td valign="top"><input name="phone" id="phone" type="text" data-validation="required" class="input validate[required,custom[integer]] textbox fstChUPPRCase" style="width:210px"/></td>
					</tr>					
					<tr>
					<td width="" valign="top"><label>Noofcopies<em>*</em></label></td>
					<td valign="top"><input name="phone" id="phone" type="text" data-validation="required" class="input validate[required,custom[integer]] textbox fstChUPPRCase" style="width:210px"/></td>
					</tr>	
