...
.spanClr{
	...
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Supplier Master</b></h3>
		...
		<div>
			...
			<tbody>
				...
				<tr>
					<td width="" valign="top"><label>Contact Person <em>*</em></label></td>
