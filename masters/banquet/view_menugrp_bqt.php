...
<table class="table table-condensed table-hover table-striped table-bordered frmBgClr" cellpadding="0" cellspacing="0" border="0" class="table" style="margin:0 0 15px 0px;text-align:center;font-size:12px;">
	<tr class="info">
		...
		<td colspan="13" style="text-align:center;"><h3 class="viewDT" id="Userhd"><b>View  Menu Item Sub Category(Bqt)</b></h3><b></b></td>
	</tr>
	<tr>
	...
	<?php 
	$sql=mysql_query("select * from bq_menugrp");
	$x=0;
	...
	<tr>
		...
		<!--<td width="80"><?php echo $row['menu_code']; ?></td>-->
		<td width="80" class="codesUPPERCase"><?php echo $row['menu_name']; ?></td>
		<td width="80" class="fstChUPPRCase"><?php echo $status; ?></td>
		<td width="80">
		<a href="edit_menugrp_bqt.php?menugrp_id=<?php echo $row['menugrp_id']; ?>" style="" class="">Edit</a>&nbsp;
		</td>
	</tr>
	<?php } } ?>	
