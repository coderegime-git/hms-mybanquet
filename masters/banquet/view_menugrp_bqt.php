...
<div class="mypay-container">
    ...
    <div class="mypay-actions-bar">
        <a href="menu_group_bqt.php" class="btn-mypay-add" id="add" title="Add Menu Group (Ctrl+A)">
    ...
    <table class="mypay-table" cellpadding="0" cellspacing="0">
        <thead>
            <tr class="banner-row">
                <th colspan="6">VIEW MENU GROUP</th>
            </tr>
            <tr class="header-row">
                <th style="width: 8%;">Sl.No</th>
                <th style="width: 20%;">Code</th>
                <th style="width: 32%;">Name</th>
                <th style="width: 18%;">Display Order</th>
        ...
        <tbody>
        <?php 
        $sql = mysql_query("select * from bq_menugrp order by menugrp_id asc");
        $x = 0;
        ...
        ?>
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['disp_order']); ?></td>
                <td>
                    <span class="badge-status <?php echo $badgeClass; ?>"><?php echo $statusText; ?></span>
                </td>
                <td>
                    <a href="edit_menugrp_bqt.php?menugrp_id=<?php echo $row['menugrp_id']; ?>" class="mypay-edit-btn" title="Edit">
