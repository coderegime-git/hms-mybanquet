...
.spanClr{
	...
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Store Master</b></h3>
		...
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="source_code" id="source_code" data-validation="required" class="input validate[required] codesUPPERCase tobCode" onblur="checkBusinessSource();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Description<em>*</em></label></td>
						<td valign="top"><input type="text" name="source_desc" id="source_desc" data-validation="required" class="input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
