...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#taxDetailsForm').attr('action', '../../action/add_tax_details.php');  
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        ...
        <form id="taxDetailsForm" name="taxDetailsForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_tax_details.php" method="post">
