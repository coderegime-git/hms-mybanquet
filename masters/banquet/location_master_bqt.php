...
.spanClr{
	...
	<h3 id="Userhd"><b>Location Master(BQT)</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_location.php" method="post" class="" style="">
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="loc_code" id="loc_code" data-validation="required" class="textbox input validate[required] codesUPPERCase tobCode" onblur="checkBusinessSource();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Location Name<em>*</em></label></td>
						<td valign="top"><input type="text" name="loc_desc" id="loc_desc" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
