...
<tr class="info">
<td colspan="13" style="text-align:center;"><h3 class="viewDT" id="Userhd"><b>View Menu Master(Bqt)</b></h3><b></b></td>
</tr>
<tr>
	...
	<!--<th width="80" style="text-align:center;background-color:#F5F5F5;">Display order</th>-->
	<th width="80" style="text-align:center;background-color:#F5F5F5;">Sub menu</th>
	...
	<?php 
	$sql=mysql_query("select * from bq_menumaster");
	$x=0;
	...
	<tr>
		...
		<td width="80" style="text-align:left;"><?php echo $row['menu_code']; ?></td>
		<td width="80" class="codesUPPERCase" style="text-align:left;"><?php echo $row['menu_name']; ?></td>
		<td width="80" class="codesUPPERCase" style="text-align:left;"><?php echo $row['menu_group']; ?></td>
		<!--<td width="80" class="codesUPPERCase" style="text-align:left;"><?php /* echo $row['disp_ord']; */ ?></td>-->
		<td width="80" class="codesUPPERCase" style="text-align:left;"><?php echo $row['submenu']; ?></td>
		<td width="80" class="codesUPPERCase" style="text-align:left;"><?php echo $row['allow_qty']; ?></td>
