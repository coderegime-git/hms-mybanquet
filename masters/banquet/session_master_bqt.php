...
.spanClr{
	...
	<h3 id="Userhd"><b>Session Master(BQT)</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_sess_mast.php" method="post" class="" style="">
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="sess_code" id="sess_code" data-validation="required" class="textbox input validate[required] codesUPPERCase tobCode" onblur="checkBusinessSource();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Session Name<em>*</em></label></td>
						<td valign="top"><input type="text" name="sess_name" id="sess_name" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>From Time<em>*</em></label></td>
						<td valign="top"><input type="text" name="from_time" id="from_time" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onkeyup="checkFromTime();"/></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>To Time<em>*</em></label></td>
						<td valign="top"><input type="text" name="to_time" id="to_time" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onkeyup="checkToTime();"/></td>
