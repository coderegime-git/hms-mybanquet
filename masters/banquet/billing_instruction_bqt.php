...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#billInstForm').attr('action', '../../action/add_bill_instr.php');  
            $('#billInstForm').submit(); 
        }); 
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        <div class="mypay-card-header">
            ADD BILLING INSTRUCTION(BQT)
        </div>

        <form id="billInstForm" name="billInstForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_bill_instr.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="bill_code" id="bill_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="bill_desc" id="bill_desc" data-validation-engine="validate[required]" class="mypay-input validate[required]" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
