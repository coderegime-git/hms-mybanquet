...
.spanClr{
	...
	<h3 id="Userhd"><b>Bank Master(BQT)</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_bank_name.php" method="post" class="" style="">
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="bank_code" id="bank_code" data-validation="required" class="textbox input validate[required] codesUPPERCase tobCode" onblur="checkBankCode();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Bank Name<em>*</em></label></td>
						<td valign="top"><input type="text" name="bank_name" id="bank_name" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBankName();"/></td>
