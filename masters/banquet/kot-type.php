...
.spanClr{
	...
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>KOT Type</b></h3>
	<form id="hotelDefi" name="hotelDefi" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_kot_type.php" method="post" class="" style="">
		<div>
			...
			<tbody>
				...
				<tr>
						<td width="" valign="top"><label>KOT Type<em>*</em></label></td>
						<td valign="top"><input name="kot_type" id="kot_type" type="text" class="input required textbox codesUPPERCase" onblur="checkPropertyCode();" style="width:210px"/>
						</td>
				</tr>
					<tr>
						<td width="" valign="top"><label>Description<em>*</em></label></td>
						<td valign="top"><input name="kot_desc" id="kot_desc" type="text" class="input required textbox codesUPPERCase" style="width:210px" /></td>
					</tr>
					<tr>
