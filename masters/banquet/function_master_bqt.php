...
.spanClr{
	...
	<h3 id="Userhd"><b>Function Master(BQT)</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_func_mast.php" method="post" class="" style="">
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="func_code" id="func_code" data-validation="required" class="textbox input validate[required] codesUPPERCase tobCode" onblur="checkBusinessSource();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Function Name<em>*</em></label></td>
						<td valign="top"><input type="text" name="func_desc" id="func_desc" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
