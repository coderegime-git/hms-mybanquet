...
/* Centered Form Card Matching Payroll Add Page Exactly */
.mypay-card {
...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#businessSourceForm').attr('action', '../../action/add_business_source.php');  
...
function checkBusinessSource() {
    var source_code = $('#bs_code').val().trim();
...
function checkBusinessDesc(){
    var source_desc = $('#bs_name').val().trim();
    if(source_desc == '') return;
    $.ajax({
        type: 'GET',
...
<div class="mypay-container">
    ...
    <!-- Add Form Card Matching Payroll Design Exactly -->
    <div class="mypay-card">
        <div class="mypay-card-header">
            ADD BUSINESS SOURCE
        </div>

        <form id="businessSourceForm" name="businessSourceForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_business_source.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="bs_code" id="bs_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" onblur="checkBusinessSource();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="bs_name" id="bs_name" data-validation-engine="validate[required]" class="mypay-input validate[required]" onblur="checkBusinessDesc();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
