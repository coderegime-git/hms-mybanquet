...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#marketSegmentForm').attr('action', '../../action/add_market_segment.php');  
...
function checkMarketsegmentname(){
    var segment_name = $('#msname').val().trim();
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        ...
        <form id="marketSegmentForm" name="marketSegmentForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_market_segment.php" method="post">
            <div class="mypay-card-body">
                <table class="mypay-form-table" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
                            <td class="mypay-label-cell">
                                <label for="mscode">Segment Code<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="mscode" id="mscode" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" onblur="checkMarketsegment();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                                <label for="msname">Segment Name<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="msname" id="msname" data-validation-engine="validate[required]" class="mypay-input validate[required]" onblur="checkMarketsegmentname();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
