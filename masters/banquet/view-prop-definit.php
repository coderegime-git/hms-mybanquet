...
<div style="margin:0px 0 10px 750px;">
		<a href="business-source.php"><button type="button" id="add" class="button_example bnkSbt" onclick="return checkUnitMaster();" style="margin:4px 0 -8px 209px;"><img src="../../images/add-contact-iconn.png" class="sbtBtnImg"/>&nbsp;&nbsp;<span class="btnUndLine">A</span>dd Prop Definition</button></a>
</div>
<table class="table table-condensed table-hover table-striped table-bordered" cellpadding="0" cellspacing="0" border="0" class="table" style="margin:0 0 15px -5px;text-align:center;font-size:12px;">
	<tr class="info">
		...
		<td colspan="13" style="text-align:center;"><h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>View Property Definition</b></h3><b></b></td>
	</tr>
	<tr>
	...
	<?php 
	$sql=mysql_query("select * from  property_definition");
	$x=0;
	...
	<tr>
		...
		<td width="80"><?php echo $row['prop_code']; ?></td>
		...
		<td width="80">
		<a href="edit_propdef.php?propId=<?php echo $row['propdef_id']; ?>" style="" class="">Edit</a>&nbsp;
		<input type="hidden" id="propdef_id" name="propdef_id" value="<?php echo $row['propdef_id']; ?>"/>
		</td>
	</tr>
	<?php } } else{ ?>	
	<div style="margin: 21px 0 26px 10px;;width:95%;" class="alert alert-success">
                               You have not created any Business source details...
    </div>
<?php } ?>
</table>
