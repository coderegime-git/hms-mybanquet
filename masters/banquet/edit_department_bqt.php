...
$deptmt_id = isset($_GET['deptmt_id']) ? mysql_real_escape_string($_GET['deptmt_id']) : '';
$sql = mysql_query("select * from bq_deptmt where deptmt_id='$deptmt_id'");
...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#departmentForm').attr('action', '<?php echo $home_path;?>/action/update_department_bqt.php');  
            $('#departmentForm').submit(); 
        }); 

        shortcut.add("Ctrl+V", function() { 
            window.location.href = "view_department_bqt.php";
        });
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        <div class="mypay-card-header">
            UPDATE DEPARTMENT(BQT)
        </div>

        <form id="departmentForm" name="departmentForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/update_department_bqt.php" method="post">
            <input type="hidden" name="deptmt_id" id="deptmt_id" value="<?php echo htmlspecialchars($deptmt_id);?>"/>
                    ...
                    <tbody>
                        <tr>
                            <td class="mypay-label-cell">
                                <label for="dept_code">Department Code<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="dept_code" id="dept_code" class="mypay-input" style="text-transform:uppercase;" value="<?php echo htmlspecialchars($row['dept_code']);?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                                <label for="dept_name">Department Name<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="dept_name" id="dept_name" data-validation-engine="validate[required]" class="mypay-input validate[required]" value="<?php echo htmlspecialchars($row['dept_name']);?>" onblur="checkDepartmentName();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
            ...
            <div class="mypay-card-footer">
                ...
                <a href="view_department_bqt.php" class="btn-mypay-action" title="View (Ctrl+V)">
