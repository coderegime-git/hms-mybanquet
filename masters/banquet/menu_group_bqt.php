...
$(document).ready(function(){
 ...
 shortcut.add("Ctrl+S",function() { 
	 $('#taxTypes').attr('action', '../../action/add_menugrp_bqt.php');  
	 $('#taxTypes').submit(); 
}); 
...
.spanClr{
	...
	<h3 id="Userhd"><b>Menu Group Code(BQT)</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_menugrp_bqt.php" method="post" class="" style="">
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="menu_code" id="menu_code" data-validation="required" class="textbox input validate[required] codesUPPERCase tobCode" onblur="checkDepartmentCode();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Menu Group Name<em>*</em></label></td>
						<td valign="top"><input type="text" name="menu_name" id="menu_name" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkDepartmentName();"/></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>Display Order<em>*</em></label></td>
						<td valign="top"><input type="text" name="disp_order" id="disp_order" data-validation="required" class="textbox input validate[required] fstChUPPRCase"/></td>
