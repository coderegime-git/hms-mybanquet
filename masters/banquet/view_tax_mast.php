...
<div class="mypay-container">
    ...
    <div class="mypay-actions-bar">
        <a href="tax_master_bqt.php" class="btn-mypay-add" id="add" title="Add Tax Master (Ctrl+A)">
            <span class="mypay-icon-plus"><i class="fa fa-plus"></i></span>
            <span>Add Tax Master</span>
        </a>
    ...
    <table class="mypay-table" cellpadding="0" cellspacing="0">
        <thead>
            <tr class="banner-row">
                <th colspan="4">VIEW TAX MASTER</th>
            </tr>
            <tr class="header-row">
        ...
        <tbody>
        <?php 
        $sql = mysql_query("select * from bq_taxmast order by taxmast_id asc");
        ...
        ?>
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['tax_desc']); ?></td>
                <td>
                    <span class="badge-status <?php echo $badgeClass; ?>"><?php echo $statusText; ?></span>
                </td>
                <td>
                    <a href="edit_taxmast.php?taxId=<?php echo $row['taxmast_id']; ?>" class="mypay-edit-btn" title="Edit">
