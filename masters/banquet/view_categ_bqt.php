...
<div class="mypay-container">
    ...
    <div class="mypay-actions-bar">
        <a href="item_category_bqt.php" class="btn-mypay-add" id="add" title="Add Item Category (Ctrl+A)">
    ...
    <table class="mypay-table" cellpadding="0" cellspacing="0">
        <thead>
            <tr class="banner-row">
                <th colspan="5">VIEW ITEM CATEGORY</th>
            </tr>
            <tr class="header-row">
                <th style="width: 15%;">Code</th>
                <th style="width: 35%;">Name</th>
                <th style="width: 25%;">Group Code</th>
        ...
        <tbody>
        <?php 
        $sql = mysql_query("select * from bq_itemcat order by itemcat_id asc");
        ...
        ?>
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['grp_name']); ?></td>
                <td>
                    <span class="badge-status <?php echo $badgeClass; ?>"><?php echo $statusText; ?></span>
                </td>
                <td>
                    <a href="edit_itemcat_bqt.php?itemcat_id=<?php echo $row['itemcat_id']; ?>" class="mypay-edit-btn" title="Edit">
        ...
        ?>
            <tr>
                <td colspan="5" style="padding: 16px; color: #777; text-align: center; font-size: 13px;">
                    No Item Category records found
                </td>
            </tr>
        <?php } ?>
        </tbody>
