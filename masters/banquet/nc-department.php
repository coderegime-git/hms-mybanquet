...
.spanClr{
	...
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Non Chargeable Department</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_nc_department.php" method="post" class="" style="">
		<div>
			...
			<tbody>
				...
				<tr>
						...
						<td valign="top"><input type="text" name="ncdept_code" id="ncdept_code" class="textbox input required" />
						</td>
				...
				<tr>
					...
					<td valign="top"><input type="text" name="ncdept_name" id="ncdept_name" class="textbox input required" onblur="checkTaxCode();" /></td>
				</tr>
				<tr>
