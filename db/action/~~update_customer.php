...
$sqll=$sqll."saddress1='".$_POST['saddress1']."',";
$sqll=$sqll."saddress2='".$_POST['saddress2']."',";
$sqll=$sqll."scity='".$_POST['scity']."',";
$sqll=$sqll."spincode='".$_POST['spincode']."',";
$sqll=$sqll."sstate='".$_POST['sstate']."',";
$sqll=$sqll."scountry='".$_POST['scountry']."',";
