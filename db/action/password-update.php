...
if(isset($_POST['npass']))
{
  if($o_pass==$_POST['opass'])
  {
	...
	$sql="UPDATE `user` SET `password` = '".$_POST['npass']."', `reenter_pass` = '".$_POST['repass']."', `status` = '".$_POST['status']."' WHERE `user_name` = '$userName' ";
	}
	if($_SESSION['user']!='admin'){
	$sql="UPDATE `user` SET `password` = '".$_POST['npass']."', `reenter_pass` = '".$_POST['repass']."' WHERE `user_name` = '$userName' ";
	}
