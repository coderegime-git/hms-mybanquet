		...
		<div class="" style="">
			...
			<table style="left:0;width:100%;">
				<tr>
					...
					<td>
						<input name="from_date" style="width:100px;margin-bottom:0px;text-align:center;" type="text" class="textbox datepicker" id="from_date" value="<?php if (isset($_GET['todate'])) {
																																											echo $_GET['fromdate'];
																																										} ?>" onChange="showsales()" placeholder="From Date" />
					</td>

					<td><label style="width:70px;"><b>To :</b></label></td>
					<td style="width:80px;">
						<input name="to_date" style="width:100px;margin:0px 3px 0 0;text-align:center;" type="text" class="textbox datepicker1" id="to_date" value="<?php if (isset($_GET['todate'])) {
																																										echo $_GET['todate'];
																																									} ?>" onChange="showsales()" placeholder="To Date" />
					</td>
					...
					<td>
						...
						<select name="menu_type" id="menu_type" style="width:90px;margin:0 0 0 -26px" onChange="showMnuType()">
							...
							<option value="All" <?php if (isset($_GET['mnuTy'])) {
													echo ($_GET['mnuTy'] == 'All') ? 'selected' : '';
												} ?>>All</option>
				...
				<table class="table table-condensed table-hover table-striped table-bordered" cellpadding="0" cellspacing="0" border="0" class="table" style="margin:0px 0 0px 0px;text-align:center;font-size:12px;width:99%;">
					<tr class="info">
						...
						<td colspan="9" style="text-align:center;">
							<h3 class="viewDTT"><b>ITEM WISE SALES REPORT from <?php if (isset($_GET['fromdate'])) {
																					echo $_GET['fromdate'];
																				} ?> to <?php if (isset($_GET['todate'])) {
																																						echo $_GET['todate'];
																																					} ?></b></h3><b></b>
						</td>
					</tr>
						...
						<div>
							<div>
								<table border="1" cellpadding="0" cellspacing="0" style="text-align:center;font-size:12px;">
									<thead>
										<tr>
											<th class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;background-color:#7B0E0E;color:#fff;width:10%;">
												<div label="Sl.no"></div>
											</th>
											<th class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;background-color:#7B0E0E;color:#fff;width:10%;">
												<div label="Date"></div>
											...
											<th class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;background-color:#7B0E0E;color:#fff;width:10%;">
												<div label="Bill no"></div>
											</th>
											<th class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;background-color:#7B0E0E;color:#fff;width:10%;">
												<div label="Code"></div>
											</th>
											<th class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;background-color:#7B0E0E;color:#fff;width:15%;">
												<div label="Name"></div>
											</th>
											<th class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;background-color:#7B0E0E;color:#fff;width:20%;">
												<div label="Qty"></div>
											</th>
											<th class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;background-color:#7B0E0E;color:#fff;width:15%;">
												<div label="Rate"></div>
									...
									<thead class="dispSHw" style="display:none;">
										...
										<tr>
											<td colspan="9" style="text-align:center;">
												<h3 class="viewDT"><b>ITEM WISE SALES REPORT from <?php if (isset($_GET['fromdate'])) {
																										echo $_GET['fromdate'];
																									} ?> to <?php if (isset($_GET['todate'])) {
																																											echo $_GET['todate'];
																																										} ?></b></h3><b></b>
