...
<thead>
		...
		<th class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;"><div label="Amount" ></div></th>
...
<tr>
	...
	<th width="80" class="codesUPPERCase" style="text-align:center;background-color:#F5F5F5;width:80px;">Amount</th>
...
<tr>
    ...
    <td width="" class="fstChUPPRCase" style="text-align:left;"><?php echo $amount; ?></td>	
