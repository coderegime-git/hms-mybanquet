...
<form id="quotationmaster" name="quotationmaster" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_custpurOrder.php" method="post" class="custmaster" style="margin: 0 0 12px 0;">
...
<div>
	...
	<tr>
		...
		<td>
			<input name="rfq_no" id="rfq_no" type="text" onclick="selectQuoteREFQ();" data-validation="required" class="input validate[required] textbox codesUPPERCase" />
			<div id="suggesstion-box"></div>
		</td>
	</tr>
			<tr>
				<td width="180" >Contract No./PO.No.:</td>
				<td><input name="custpo_no" id="customerpo_no" type="text" data-validation="required" class="input validate[required] textbox codesUPPERCase"/></td>
			</tr>
			<tr>
				<td width="180" >PR Number:</td>
				<td><input name="pr_number" id="pr_number" type="text" class="textbox"/></td>
			</tr>
			<tr>
				<td width="180" >NSN No:</td>
				<td ><input name="nsn_no" id="nsn_no" type="text" data-validation="required" class="input validate[required] textbox" value=""/></td>
			</tr>
			<tr>
				<td width="180" >Total Qty :</td>
				<td><input name="total_qty" id="total_qty" type="text" class="textbox " value="" onblur="excTotQTY();" style="width:90px;" /><input name="bal_qty" id="bal_qty" type="text" class="textbox " value="" style="width:89px;" placeholder="Balance qty" readonly /></td>
			</tr>
			<tr>
		...
		<table style="width:50%;border-left:1px solid #ddd;" class="table">
			...
			<tr>
				...
				<td><input name="special_req" id="spec_req" type="text" data-validation="required" class="input validate[required] textbox"/></td>
			</tr>
...
<table style="float:left;width:50%;border-right:1px solid #ddd;" cellpadding="0" cellspacing="0" border="0" class="table" >
			...
			<tr>
				...
				<td>
				<input name="part_number" id="part_number" type="text" data-validation="required" class="input validate[required] textbox" />
				</td>
			</tr>
			<tr>
				<td width="180" >Nomenclature:</td>
				<td><input name="part_nomen" id="part_name" type="text" data-validation="required" class="input validate[required] textbox"/></td>
			</tr>
		...
		<table style="width:50%;border-left:1px solid #ddd;" class="table">
			<tr>
				...
				<td >
					<input name="unit_issue" id="unit_issue" type="text" data-validation="required" class="input validate[required] textbox"/>
				</td>
			</tr>
			<tr>
				<td width="180" >Packing Type *:</td>
				<td>
					<input name="packing_type" id="packing_type" type="text" data-validation="required" class="input validate[required] textbox codesUPPERCase" onkeyup="pacTYpeCp();"/>
				</td>
			</tr>
	</table>
...
<div id="cpoDIV" style="display:none;">		
<table style="float:left;width:99%;border-right:1px solid #ddd;" cellpadding="0" cellspacing="0" border="0" class="table" >
	...
	<tbody>
	<tr>
	<td><input name="heading1" id="heading1" type="text" value="QUP" class="textbox headeR" readonly /></td>
	<td><input name="detail1" id="detail1" type="text" value="Quantity per Unit Pack" class="textbox" readonly /></td>
	<td><input name="table1" id="table1" type="text" value="Page 142, Para J4.3" class="textbox" readonly /></td>
	<td><input name="code1" id="code1" type="text" value="" class="textbox headeR selctCOde selCde" onblur="selctPacCOde1();" /></td>
	<td><input name="require1" id="require1" type="text" value="" class="textbox headeTxt selctReq" /></td>
	</tr>
	<tr>
	...
	<td><input name="table1" id="table2" type="text" value="Page 143, Para J4.11" class="textbox" readonly /></td>
	<td><input name="code2" id="code2" type="text" value="" class="textbox headeR selctCOde" onblur="selctPacCOde2();"/></td>
	<td><input name="require2" id="require2" type="text" value="" class="textbox headeTxt selctReq"/></td>
	</tr>
	<tr>
	...
	<td><input name="code3" id="code3" type="text" value="" class="textbox headeR" onblur="selctPacCOde3();"/></td>
	<td><input name="require3" id="require3" type="text" value="" class="textbox headeTxt selctCOde"/></td>
	</tr>
	<tr>
	...
	<td><input name="table4" id="table4" type="text" value="Page J II" class="extbox" readonly /></td>
	<td><input name="code4" id="code4" type="text" value="" class="textbox headeR" onblur="selctPacCOde4();"/></td>
	<td><input name="require4" id="require4" type="text" value="" class="textbox headeTxt selctCOde"/></td>
	</tr>
	<tr>
	...
	<td><input name="code5" id="code5" type="text" value=""  class="textbox headeR" onblur="selctPacCOde5();"/></td>
	<td><input name="require5" id="require5" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code6" id="code6" type="text" value=""class="textbox headeR" onblur="selctPacCOde6();"/></td>
	<td><input name="require6" id="require6" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code7" id="code7" type="text" value="" class="textbox headeR" onblur="selctPacCOde7();"/></td>
	<td><input name="require7" id="require7" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code8" id="code8" type="text" value="" class="textbox headeR" onblur="selctPacCOde8();"/></td>
	<td><input name="require8" id="require8" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code9" id="code9" type="text" value=""class="textbox headeR" onblur="selctPacCOde9();"/></td>
	<td><input name="require9" id="require9" type="text" value="" class="textbox headeTxt"/></td>

	</tr>
	<tr>
	<td><input name="heading10" id="heading10" type="text" value="IC"  class="textbox headeR" readonly /></td>
	...
	<td><input name="code10" id="code10" type="text" value="" class="textbox headeR" onblur="selctPacCOde10();"/></td>
	<td><input name="require10" id="require10" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code11" id="code11" type="text" value="" class="textbox headeR" onblur="selctPacCOde11();"/></td>
	<td><input name="require11" id="require11" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code12" id="code12" type="text" value="" class="textbox headeR" onblur="selctPacCOde12();"/></td>
	<td><input name="require12" id="require12" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code13" id="code13" type="text" value="" class="textbox headeR" onblur="selctPacCOde13();"/></td>
	<td><input name="require13" id="require13" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code14" id="code14" type="text" value=""  class="textbox headeR" onblur="selctPacCOde14();"/></td>
	<td><input name="require14" id="require14" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code15" id="code15" type="text" value="" class="textbox headeR" onblur="selctPacCOde15();"/></td>
	<td><input name="require15" id="require15" type="text" value="" class="textbox headeTxt"/></td>
	...
	<td><input name="code16" id="code16" type="text" value="" class="textbox headeR" onblur="selctPacCOde16();"/></td>
	<td><input name="require16" id="require16" type="text" value="" class="textbox headeTxt"/></td>
	</tr>
	</tbody>
</table>			
</div>
