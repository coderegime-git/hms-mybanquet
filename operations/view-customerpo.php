...
<div class="about">
	...
	?>
		<tbody>
			<tr >
			<td><?php echo $x; ?></td>
			<td><input name="chk[]"  type="checkbox" id="c_<?php echo $row['customerpo_id']?>" class="ckPrint group1 check_" value="<?php echo $row['customerpo_id']?>" onclick="setPrint(this.id,this.value);" /></td>
			...
			<td>
			<div style="display:inline"; id="ed<?php echo $row['customerpo_id'];?>">
			<a title="Edit Customer Details" href="update-customerpo.php?uid=<?php echo $row['customerpo_id']?>" style="color:#005580;">Edit</a>
			</div>
			</td>
<!--<td>		
