...
$phone=$rowPd['phone'];
	...
	<tr>
		<td colspan="24" style="text-align:center;font-size:14px;font-weight:bold;">Function wise sales Report</td>
	</tr>
...
$output.='<tr>
<td style="text-align:left;width:120px;color:#FF0034;font-weight:bold;" colspan="24">'. strtoupper($rwp['func_desc']).'</td>
</tr>';
...
$output.='</table>';
$fileName = 'Function wise-Report'.date('d-M-Y-H-i-s').'.xls';
