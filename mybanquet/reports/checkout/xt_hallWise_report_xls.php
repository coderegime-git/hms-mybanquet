...
$phone=$rowPd['phone'];
	...
	<tr>
		<td colspan="24" style="text-align:center;font-size:14px;font-weight:bold;">Venue wise sales Report</td>
	</tr>
...
$output.='<tr>
	...
	<td width="" class="codesUPPERCase bN" style="width:100px;text-align:left;color:'. $bgcolor.'" >'.$row['bill_no'].'</td>
...
$output.='</table>';
$fileName = 'HallWise-Details'.date('d-M-Y-H-i-s').'.xls';
