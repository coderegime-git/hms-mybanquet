...
.spanClr{
	...
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Sub Menu Category</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_submenu_category.php" method="post" class="" style="">
		<div>
			...
			<tbody>
				...
				<tr>
						...
						<td valign="top">
						<?php $sqlRt=mysql_query("select * from pos_menucat");?>
							<select name="submn_cat" id="submn_cat" class="textbox input required fstChUPPRCase">
							<option value="">--Select--</option>
							<?php while($rowRt=mysql_fetch_array($sqlRt)){?>
							<option class="codesUPPERCase" value="<?php echo $rowRt['menu_catcd'];?>" ><?php echo $rowRt['menu_catnam'];?></option>
							<?php } ?>
							</select>
						</td>
				...
				<tr>
					<td width="" valign="top"><label>Sub Menu Category Code <em>*</em></label></td>
					<td valign="top"><input type="text" name="submn_catcd" id="submn_catcd" class="textbox input required" onblur="checkTaxCode();" /></td>
				</tr>
				<tr>
					<td width="" valign="top"><label>Sub Menu Category Name <em>*</em></label></td>
					<td valign="top"><input type="text" name="submn_catnm" id="submn_catnm" class="textbox input required" onblur="checkTaxCode();" /></td>
				</tr>
