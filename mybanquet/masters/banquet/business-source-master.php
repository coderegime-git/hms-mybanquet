...
function checkBusinessDesc(){
	...
	$.ajax({
		type:'GET',
		url:'  ../../action/repeatBusinessSourceDesc.php',
			data:{
		...
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="bs_code" id="bs_code" data-validation="required" class="textbox input validate[required] codesUPPERCase tobCode" onblur="checkBusinessSource();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Business Source Name<em>*</em></label></td>
						<td valign="top"><input type="text" name="bs_name" id="bs_name" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
