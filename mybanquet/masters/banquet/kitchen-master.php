...
.spanClr{
	...
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Kitchen</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_kitchen_master.php" method="post" class="" style="">
		<div>
			<table cellpadding="0" cellspacing="0" class="table" border="0" style="margin:4px 0 0 0;" >
			<tbody>

				<tr>
						<td width="" valign="top"><label>Kitchen Code<em>*</em></label></td>
						<td valign="top"><input type="text" id="kitc_code" name="kitc_code" class="textbox input required" />
						</td>
						
						
				</tr>
				<tr>
					<td width="" valign="top"><label>Kitchen Name<em>*</em></label></td>
					<td valign="top"><input type="text" name="kitc_desc" id="kitc_desc" class="textbox input required"/></td>
				</tr>
				<tr>
					<td width="" valign="top"><label>Kitchen Printer (KOT)<em>*</em></label></td>
					<td valign="top"><input type="text" name="kitc_print" id="kitc_print" class="textbox input required"/></td>
				</tr>
