...
$locMd = isset($_GET['locMd']) ? mysql_real_escape_string($_GET['locMd']) : '';
$sql = mysql_query("select * from bq_location where locat_id='$locMd'");
...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#locationForm').attr('action', '<?php echo $home_path;?>/action/update_location.php');  
            $('#locationForm').submit(); 
        }); 
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        <div class="mypay-card-header">
            UPDATE LOCATION MASTER(BQT)
        </div>

        <form id="locationForm" name="locationForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/update_location.php" method="post">
            <input type="hidden" name="locat_id" id="locat_id" value="<?php echo htmlspecialchars($locMd);?>"/>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="loc_code" id="loc_code" class="mypay-input" style="text-transform:uppercase;" value="<?php echo htmlspecialchars($row['loc_code']);?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="loc_desc" id="loc_desc" data-validation-engine="validate[required]" class="mypay-input validate[required]" value="<?php echo htmlspecialchars($row['loc_desc']);?>" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
