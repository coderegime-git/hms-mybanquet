...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#seatingForm').attr('action', '../../action/add_seating_code.php');  
            $('#seatingForm').submit(); 
        }); 
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        <div class="mypay-card-header">
            ADD SEATING MASTER(BQT)
        </div>

        <form id="seatingForm" name="seatingForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_seating_code.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="seat_code" id="seat_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="seat_desc" id="seat_desc" data-validation-engine="validate[required]" class="mypay-input validate[required]" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
