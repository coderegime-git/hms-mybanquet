...
.spanClr{
	...
	<div id="addcustomer" class="frmCentr divBrd" style="border:1px solid #ddd;width:468px;">
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Menu Category</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_menu_category.php" method="post" class="" style="">
		<div>
			...
			<tbody>
				<tr>
					...
					<td valign="top">
					<select name="menu_type" id="menu_type" class="textbox input required">
					...
					<!--<input type="text" name="menu_type" id="menu_type" class="textbox input required" />-->
					</td>
				</tr>
				<tr>
					<td width="" valign="top"><label>Menu Category Code <em>*</em></label></td>
					<td valign="top"><input type="text" name="menu_catcd" id="menu_catcd" class="textbox input required" onblur="checkTaxCode();" /></td>
				</tr>
				<tr>
					<td width="" valign="top"><label>Menu Category Name <em>*</em></label></td>
					<td valign="top"><input type="text" name="menu_catnam" id="menu_catnam" class="textbox input required" onblur="checkTaxCode();" /></td>
				</tr>
