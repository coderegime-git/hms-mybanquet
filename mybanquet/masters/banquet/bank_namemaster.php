...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#bankForm').attr('action', '../../action/add_bank_name.php');  
            $('#bankForm').submit(); 
        }); 
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        ...
        <form id="bankForm" name="bankForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_bank_name.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="bank_code" id="bank_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" onblur="checkBankCode();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="bank_name" id="bank_name" data-validation-engine="validate[required]" class="mypay-input validate[required]" onblur="checkBankName();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
