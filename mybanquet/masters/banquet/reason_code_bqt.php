...
.spanClr{
	...
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Reason Codes</b></h3>
		...
		<div>
			...
			<tbody>
					<tr>
						<td width="" valign="top"><label>Reason Code <em>*</em></label></td>
						<td valign="top"><input type="text" name="tax_code" id="source_code" class="input required codesUPPERCase tobCode" onblur="checkBusinessSource();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Reason Name<em>*</em></label></td>
						<td valign="top"><input type="text" name="tax_desc" id="source_desc" class="input required fstChUPPRCase" /></td>
						
					</tr>
					<tr>
						<td><label>Reason Tag </label></td>
