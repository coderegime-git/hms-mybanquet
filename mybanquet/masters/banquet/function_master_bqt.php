...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#functionForm').attr('action', '../../action/add_func_mast.php');  
            $('#functionForm').submit(); 
        }); 
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        <div class="mypay-card-header">
            ADD FUNCTION MASTER(BQT)
        </div>

        <form id="functionForm" name="functionForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_func_mast.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="func_code" id="func_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="func_desc" id="func_desc" data-validation-engine="validate[required]" class="mypay-input validate[required]" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
