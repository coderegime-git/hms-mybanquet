...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#sessionForm').attr('action', '../../action/add_sess_mast.php');  
            $('#sessionForm').submit(); 
        }); 
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        <div class="mypay-card-header">
            ADD SESSION MASTER(BQT)
        </div>

        <form id="sessionForm" name="sessionForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_sess_mast.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="sess_code" id="sess_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="sess_name" id="sess_name" data-validation-engine="validate[required]" class="mypay-input validate[required]" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="from_time" id="from_time" data-validation-engine="validate[required]" class="mypay-input validate[required]" placeholder="HH:MM" onkeyup="checkFromTime();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="to_time" id="to_time" data-validation-engine="validate[required]" class="mypay-input validate[required]" placeholder="HH:MM" onkeyup="checkToTime();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
