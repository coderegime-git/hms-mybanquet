...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#taxMasterForm').attr('action', '../../action/add_tax_master.php');  
...
function checkTaxCode() {
    ...
    $.ajax({
        type: 'GET',
        url: '../../action/repeatBqtTaxCode.php',
...
function checkTaxDesc(){
    var tax_desc = $('#tax_desc').val().trim();
    if(tax_desc == '') return;
    $.ajax({
        type: 'GET',
        url: '../../action/repeatBqtTaxDesc.php',
        data: { tax_desc: tax_desc },
        success: function(data){
            if(data == 1){
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        ...
        <form id="taxMasterForm" name="taxMasterForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_tax_master.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="tax_code" id="tax_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" onblur="checkTaxCode();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="tax_desc" id="tax_desc" data-validation-engine="validate[required]" class="mypay-input validate[required]" onblur="checkTaxDesc();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
