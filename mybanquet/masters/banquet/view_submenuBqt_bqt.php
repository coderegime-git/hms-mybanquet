...
jQuery(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+A", function() { 
            window.location.href = "submenu_group_bqt.php";
        }); 
...
<div class="mypay-container">
    ...
    <div class="mypay-actions-bar">
        <a href="submenu_group_bqt.php" class="btn-mypay-add" id="add" title="Add Sub Menu Group (Ctrl+A)">
            <span class="mypay-icon-plus"><i class="fa fa-plus"></i></span>
            <span>Add Sub Menu Group</span>
        </a>
    ...
    <table class="mypay-table" cellpadding="0" cellspacing="0">
        <thead>
            <tr class="banner-row">
                <th colspan="6">VIEW SUB MENU GROUP</th>
            </tr>
            <tr class="header-row">
                <th style="width: 8%;">Sl.No</th>
                <th style="width: 18%;">Sub Menu Group Code</th>
                <th style="width: 32%;">Sub Menu Group Name</th>
        ...
        <tbody>
        <?php 
        $sql = mysql_query("select * from bq_submenugrp order by submng_id asc");
        $x = 0;
        ...
        ?>
            <tr>
                ...
                <td style="text-align:left;"><?php echo htmlspecialchars($row['submenu_name']); ?></td>
                <td><?php echo htmlspecialchars($row['subgrp_code']); ?></td>
                <td>
                    <span class="badge-status <?php echo $badgeClass; ?>"><?php echo $statusText; ?></span>
                </td>
                <td>
                    <a href="edit_subMnuGroup_bqt.php?submng_id=<?php echo $row['submng_id']; ?>" class="mypay-edit-btn" title="Edit">
        ...
        ?>
            <tr>
                <td colspan="6" style="padding: 16px; color: #777; text-align: center; font-size: 13px;">
                    No Sub Menu Group records found
                </td>
            </tr>
        <?php } ?>
        </tbody>
