...
<style>
 label { width: 125px; padding:0 20px 0 20px; display: inline-block;font-weight: bold;color: #000;text-align:right;font-size:13px;} 
.multiselect {
    width:11.25em;
    height:6.8em;
...
.spanClr{
	...
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Unit of Measurement</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_uom_master.php" method="post" class="" style="">
		<div>
			<table cellpadding="0" cellspacing="0" class="table" border="0" style="margin:4px 0 0 0;" >
			<tbody>

				<tr>
						<td width="" valign="top"><label>UOM Code<em>*</em></label></td>
						<td valign="top"><input type="text" name="uom_code" id="uom_code" class="textbox input required" />
						</td>
				...
				<tr>
					...
					<td valign="top"><input type="text" name="uom_desc" id="uom_desc" class="textbox input required" onblur="checkTaxCode();" /></td>
				</tr>
