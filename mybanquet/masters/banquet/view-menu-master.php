...
<div class="mypay-container">
    ...
    <div class="mypay-actions-bar">
        <a href="menu_master_bqt.php" class="btn-mypay-add" id="add" title="Add Menu Master (Ctrl+A)">
            <span class="mypay-icon-plus"><i class="fa fa-plus"></i></span>
            <span>Add Menu Master</span>
        </a>
    ...
    <table class="mypay-table" cellpadding="0" cellspacing="0">
        <thead>
            <tr class="banner-row">
                <th colspan="8">VIEW MENU MASTER</th>
            </tr>
            <tr class="header-row">
                <th style="width: 6%;">Sl.No</th>
                <th style="width: 14%;">Code</th>
                <th style="width: 24%;">Name</th>
                <th style="width: 16%;">Group Code</th>
                <th style="width: 16%;">Sub Menu</th>
                <th style="width: 10%;">Allow Qty</th>
        ...
        <tbody>
        <?php 
        $sql = mysql_query("select * from bq_menumaster order by menmas_id asc");
        $x = 0;
        ...
        ?>
            <tr>
                ...
                <td style="text-align:left;"><?php echo htmlspecialchars($row['menu_name']); ?></td>
                <td style="text-align:left;"><?php echo htmlspecialchars($row['menu_group']); ?></td>
                <td style="text-align:left;"><?php echo htmlspecialchars($row['submenu']); ?></td>
                <td><?php echo htmlspecialchars($row['allow_qty']); ?></td>
                <td>
                    <span class="badge-status <?php echo $badgeClass; ?>"><?php echo $statusText; ?></span>
                </td>
                <td>
                    <a href="edit_menumaster_bqt.php?menmas_id=<?php echo $row['menmas_id']; ?>&mencde=<?php echo urlencode($row['menu_code']); ?>" class="mypay-edit-btn" title="Edit">
        ...
        ?>
            <tr>
                <td colspan="8" style="padding: 16px; color: #777; text-align: center; font-size: 13px;">
                    No Menu Master records found
                </td>
            </tr>
        <?php } ?>
        </tbody>
