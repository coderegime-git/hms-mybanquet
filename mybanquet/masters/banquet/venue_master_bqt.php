...
.spanClr{
	...
	<h3 id="Userhd"><b>Venue Master(BQT)</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_venue_master.php" method="post" class="" style="">
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="venue_code" id="venue_code" data-validation="required" class="textbox input validate[required] codesUPPERCase tobCode" onblur="checkBusinessSource();" /></td>
					</tr>
					<tr>
						<td width="" valign="top"><label>Venue Name<em>*</em></label></td>
						<td valign="top"><input type="text" name="venue_desc" id="venue_desc" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
						
					</tr>	<tr>	<tr>
						<td width="" valign="top"><label>Location<em>*</em></label></td>
						<td valign="top"><input type="text" name="location" id="location" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
						
					</tr>
						<tr>
						<td width="" valign="top"><label>Length<em>*</em></label></td>
						<td valign="top"><input type="text" name="length" id="length" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
						
					</tr>
						<td width="" valign="top"><label>Breadth<em>*</em></label></td>
						<td valign="top"><input type="text" name="breadth" id="breadth" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
						
					</tr>
					
						<tr>
						<td width="" valign="top"><label>Height<em>*</em></label></td>
						<td valign="top"><input type="text" name="height" id="height" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
						...
						<td valign="top"><input type="text" name="area" id="area" data-validation="required" class="textbox input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
