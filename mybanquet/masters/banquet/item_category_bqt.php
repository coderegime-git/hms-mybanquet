...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#itemCatForm').attr('action', '../../action/add_itemcategory_bqt.php');  
            $('#itemCatForm').submit(); 
        }); 
...
function checkCategoryCode() {
    var cat_code = $('#cat_code').val().trim();
    if(cat_code == '') return;
    $.ajax({
        type: 'GET',
        url: '../../action/repeatBqtItemCatCode.php',
...
function checkCategoryName(){
    ...
    $.ajax({
        type: 'GET',
        url: '../../action/repeatBqtItemCatName.php',
...
<div class="mypay-container">
    ...
    <!-- Add Form Card Matching Market Segment Design Exactly -->
    <div class="mypay-card">
        <div class="mypay-card-header">
            ADD ITEM CATEGORY
        </div>

        <form id="itemCatForm" name="itemCatForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_itemcategory_bqt.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="cat_code" id="cat_code" data-validation-engine="validate[required]" class="mypay-input validate[required]" style="text-transform:uppercase;" onblur="checkCategoryCode();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="cat_name" id="cat_name" data-validation-engine="validate[required]" class="mypay-input validate[required]" onblur="checkCategoryName();" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                            ...
                            <td class="mypay-input-cell">
                                <select name="grp_name" id="grp_name" data-validation-engine="validate[required]" class="mypay-input validate[required]" required>
                                    ...
                                    ?>
                                        <option value="<?php echo htmlspecialchars($resulte['grpcode']); ?>">
