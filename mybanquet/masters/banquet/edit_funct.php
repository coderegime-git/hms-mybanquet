...
$funMd = isset($_GET['funMd']) ? mysql_real_escape_string($_GET['funMd']) : '';
$sql = mysql_query("select * from bq_function where func_id='$funMd'");
...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        shortcut.add("Ctrl+S", function() { 
            $('#functionForm').attr('action', '<?php echo $home_path;?>/action/update_func_mast.php');  
            $('#functionForm').submit(); 
        }); 

        shortcut.add("Ctrl+V", function() { 
            window.location.href = "view_func_mast.php";
        });
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        <div class="mypay-card-header">
            UPDATE FUNCTION MASTER(BQT)
        </div>

        <form id="functionForm" name="functionForm" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/update_func_mast.php" method="post">
            <input type="hidden" name="func_id" id="func_id" value="<?php echo htmlspecialchars($funMd);?>"/>
                    ...
                    <tbody>
                        <tr>
                            <td class="mypay-label-cell">
                                <label for="func_code">Function Code<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="func_code" id="func_code" class="mypay-input" style="text-transform:uppercase;" value="<?php echo htmlspecialchars($row['func_code']);?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
                                <label for="func_desc">Function Name<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="func_desc" id="func_desc" data-validation-engine="validate[required]" class="mypay-input validate[required]" value="<?php echo htmlspecialchars($row['func_desc']);?>" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="mypay-label-cell">
            ...
            <div class="mypay-card-footer">
                ...
                <a href="view_func_mast.php" class="btn-mypay-action" title="View (Ctrl+V)">
