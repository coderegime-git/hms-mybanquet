...
<?php 
	$sql=mysql_query("select * from packingpage where packingpage_id='".$_GET['uid']."'");
	$x=0;
	$row=mysql_fetch_array($sql);
		$x++;
	?>
<form id="quotationmaster" name="quotationmaster" action="<?php echo $home_path;?>/action/update_packingpage.php" method="post" class="" style="margin: 0 0 12px 0;">
<input name="packingpage_id" id="packingpage_id" type="hidden" data-validation="required" value="<?php echo $row['packingpage_id']?>" />
		<table style="float:left;width:50%;border-right:1px solid #ddd;" cellpadding="0" cellspacing="0" border="0" class="table" >
			...
			<tr>
				...
				<td id="clinDest">
					<input name="dest_code" id="clin_no1" type="text" data-validation="required" class="input validate[required] textbox" value="<?php echo $row['dest_code']?>"/>
				</td>
			</tr>
			<tr>
					<td width="180" >Packing Date :</td>
					<td >
					<input name="packing_date" id="calendar" type="text" data-validation="required" class="input validate[required] textbox" onblur="checkitemcode()" value="<?php echo $row['packing_date']?>"/>
					</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input name="contract_no" id="contract_no" type="text" data-validation="required" class="input validate[required] textbox" value="<?php echo $row['contract_no']?>"/>
				</td>
			</tr>
			
			<tr>
				<td width="180" >NSN No:</td>
				<td><input name="nsn_no" id="nsn_no" type="text" data-validation="required" class="input validate[required] textbox" value="<?php echo $row['nsn_no']?>"/></td>
			</tr>
			<tr>
				<td width="180" >Part No:</td>
				<td>
					<input name="part_no" id="part_no" type="text" data-validation="required" class="input validate[required] textbox" value="<?php echo $row['part_no']?>"/>
				</td>
			</tr>
		...
		<table style="width:50%;border-left:1px solid #ddd;" class="table">
			...
			<tr>
				...
				<td ><input name="total_qty" id="total_qty" type="text" data-validation="required" class="input validate[required] textbox" value="<?php echo $row['total_qty']?>"/></td>
			</tr>
			<tr>
				<td width="180" >CLIN Qty:</td>
				<td ><input name="clin_qty" id="clin_qty" type="text" data-validation="required" class="input validate[required,custom[integer]] textbox" value="<?php echo $row['clin_qty']?>"/></td>
			</tr>
			<!--<tr>
			...
			<tr>
				...
				<td ><input name="dest_address" id="dest_address" type="text" data-validation="required" class="input validate[required,custom[integer]] textbox" value="<?php echo $row['dest_address']?>"/></td>
			</tr>
			<tr>
				<td width="180" >Dest. Address1:</td>
				<td ><input name="dest_address1" id="dest_address1" type="text" data-validation="required" class="input validate[required,custom[integer]] textbox" value="<?php echo $row['dest_address']?>"/></td>
			</tr>
			<tr>
				<td width="180" >Packing Req:</td>
				<td ><input name="packing_req" id="packing_req" type="text" data-validation="required" class="input validate[required] textbox codesUPPERCase" value="<?php echo $row['packing_req']?>"/></td>
			</tr>
			<!--<tr>
