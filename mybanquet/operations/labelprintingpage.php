...
<form id="quotationmaster" name="quotationmaster" action="<?php echo $home_path;?>/action/add_labelprintingpage.php" method="post" class="" style="margin: 0 0 12px 0;">
			<table style="float:left;" class="table table-condensed table-disable-hover" cellpadding="0" cellspacing="0" class="table" border="0" >
				...
				<tr>
						...
						<option value="Exterior Label">Exterior Label</option>
						<option value="MSL Label">MSL Label</option>
						</select>
				...
				<tr>
						...
						<td valign="top">
						<input name="rfq_no" id="rfq_no" type="text" class="textbox" onblur="chkLABLPrintPage();"/>
						</td>
				...
				<tr>
					...
					<td valign="top">
						<input name="date" id="calendar" type="text" class="textbox" onblur="checkitemcode()"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td valign="top"><input name="clin_no" id="clin_qty" type="text" class="textbox" onblur="checkitemcode()"/></td>
					
				</tr>
					<tr>
						<td width="125" valign="top">Shipment No :</td>
						<td valign="top">
						<input name="shipment_no" id="shipment_no" type="text" class="textbox" onblur="checkitemcode()"/>
				...
				<tr>
							...
							<td valign="top"><input name="label_qty" id="label_qty" type="text" class="textbox" onblur="checkitemcode()"/></td>
							
						</tr>
						<tr>
							<td width="125" valign="top">TCN No :</td>
							<td valign="top">
							<input name="tcn_no" id="tcn_no" type="text" class="textbox" onblur="checkitemcode()"/>
						...
						<tr>
							...
							<td valign="top"><input name="package_type" id="package_type" type="text" class="textbox" onblur="checkitemcode()"/></td>
							
						</tr>
						<tr>
							<td width="125" valign="top">Total No. of pieces *:</td>
							<td valign="top"><input name="total_nopieces" id="total_nopieces" type="text" class="textbox" onblur="checkitemcode()"/></td>
			...
			<table style="" class="table">
				<tr>
					...
					<td valign="top"><input name="piece_no" id="piece_no" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>
				<tr>
					<td width="125" valign="top">Package Dimensions :</td>
					<td valign="top"><input name="package_dimension" id="package_dimension" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>
				<tr>
					<td width="125" valign="top">Cu. Wt.:</td>
					<td valign="top"><input name="cu_wt" id="cu_wt" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>
				<tr>
					<td width="125" valign="top">Cu. Area *:</td>
					<td valign="top"><input name="cu_area" id="cu_area" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>	
					
				<tr>
					<td width="125" valign="top">Contract No :</td>
					<td valign="top"><input name="contract_no" id="contract_no" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>
				<tr>
					<td width="125" valign="top">NSN No :</td>
					<td valign="top"><input name="nsn_no" id="nsn_no" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>
				<tr>
					<td width="125" valign="top">CAGE Code:</td>
					<td valign="top"><input name="cage_code" id="cage_code" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>
				<tr>
					<td width="125" valign="top">Part No:</td>
					<td valign="top"><input name="part_no" id="part_no" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>	
				<tr>
					<td width="125" valign="top">Part Name:</td>
					<td valign="top"><input name="part_name" id="part_name" type="text" class="textbox" onblur="checkitemcode()"/></td>
				</tr>	
			...
			<table style="" class="table">
						...
						<tr>
							...
							<td valign="top"><input name="qup" id="qup" type="text" class="textbox" onblur="checkitemcode()"/></td>
						...
						<!--<tr>
							<td width="125" valign="top">From Address:</td>
							<td valign="top"><input name="from_address" id="from_address" type="text" class="textbox" onblur="checkitemcode()"/></td>
							
						</tr>
						<tr>
							<td width="125" valign="top">To Address:</td>
							<td valign="top"><input name="to_address" id="to_address" type="text" class="textbox" onblur="checkitemcode()"/></td>
							
						</tr>-->
						<tr>
							<td width="125" valign="top">Priority:</td>
							<td valign="top"><input name="priority" id="priority" type="text" class="textbox" onblur="checkitemcode()"/></td>
							
						</tr>
						<tr>
							<td width="125" valign="top">Serial No :</td>
							<td valign="top"><input name="serial_no" id="serial_no" type="text" class="textbox" onblur="checkitemcode()"/></td>
							
						</tr>
						<tr>
							<td width="125" valign="top">UID No :</td>
							<td valign="top"><input name="uid_no" id="uid_no" type="text" class="textbox" onblur="checkitemcode()"/></td>
							
						</tr>
						<tr>
							<td width="125" valign="top">RFID:</td>
							<td valign="top"><input name="rfid" id="rfid" type="text" class="textbox" onblur="checkitemcode()"/></td>
