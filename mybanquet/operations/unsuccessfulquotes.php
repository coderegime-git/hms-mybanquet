...
<p style="text-align:center;">
	<span id="msgFoprop" class="msgNotifyprop"></span>
		...
		<h3 style="text-align:center;width:94%;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Unsuccessful Quotes</b></h3>
		<div id="addcustomer" style="border:1px solid #ddd;width:910px;">
		<form id="vendormaster" name="vendormaster" action="<?php echo $home_path;?>/action/add_unsuccessful_quotes.php" method="post" class="" style="margin: 0 0 12px 0;">
		...
		<tbody>
			<tr>
				...
				<td valign="top"><input name="rfq_no" id="rfq_no" type="text" data-validation="required" class="input validate[required] textbox codesUPPERCase" onblur="selUnsuccRfq();" />
				</td>
									
			</tr>
			<tr>
				<td width="145" valign="top"><label>Solicitation # :</label></td>
				<td valign="top"><input name="solic_no" id="solic_no" type="text" data-validation="required" class="input validate[required,custom[onlyLetterSp]] textbox fstChUPPRCase" /></td>
			</tr>
			<tr>
				<td width="150" valign="top"><label>NSN No:</label></td>
				<td valign="top"><input name="nsn_no" id="nsn_no" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" onblur="checkitemcode()"/></td>
			</tr>
			<tr>
				<td width="150" valign="top"><label>Qty:</label></td>
				<td valign="top"><input name="qty" id="qty" type="text" class="textbox fstChUPPRCase" onblur="checkitemcode()"/></td>
			</tr>
		...
		<table style="width:50%;" class="table">
			...
			<tr>
				...
				<td valign="top"><input name="price" id="price" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" onblur="checkitemcode()"/></td>
			</tr>
			<tr>
				<td width="125" valign="top"><label>Award To whom :</label></td>
				<td valign="top"><input name="award_whom" id="award_whom" type="text" data-validation="required" class="input validate[required] textbox" onblur="checkitemcode()"/></td>
			</tr>
			<tr>
				<td width="125" valign="top"><label>Award Price :</label></td>
				<td valign="top"><input name="award_price" id="award_price" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" onblur="checkitemcode()"/></td>
			</tr>
			<tr>
