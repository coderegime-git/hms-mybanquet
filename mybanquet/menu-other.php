...
<ul>
   ...
   <li class='<?php echo $ms; ?> has-sub'><a href='#'>Front Office</a>
      <ul>
               <?php if(in_array('prop_def',$menuVals) || $_SESSION['user'] == 'admin') { ?>
               <li><a href='<?php echo $home_path; ?>/masters/frontoffice/property-definition.php' style="cursor:pointer;" ><span>Reservations</span></a></li>
			<?php } ?>
			 ...
			 <?php if(in_array('busin_mast',$menuVals) || $_SESSION['user'] == 'admin') { ?>
              <li class='last'><a href='<?php echo $home_path; ?>/masters/frontoffice/outlet-master.php' ><span>Registrations</span></a></li>
			   <?php } ?>
			    <?php if(in_array('comp_mast',$menuVals) || $_SESSION['user'] == 'admin') { ?>
              <li class='last'><a href='<?php echo $home_path; ?>/masters/frontoffice/session-master.php' ><span>Cashier</span></a></li>
			   <?php } ?>
			   <?php if(in_array('comp_mast',$menuVals) || $_SESSION['user'] == 'admin') { ?>
              <li class='last'><a href='<?php echo $home_path; ?>/masters/frontoffice/stewart-master.php' ><span>NightAudit</span></a></li>
			   <?php } ?>
			   <?php if(in_array('comp_mast',$menuVals) || $_SESSION['user'] == 'admin') { ?>
              <li class='last'><a href='<?php echo $home_path; ?>/masters/frontoffice/menu-category.php' ><span>Guest History</span></a></li>
			   <?php } ?>
			   <?php if(in_array('comp_mast',$menuVals) || $_SESSION['user'] == 'admin') { ?>
              <li class='last'><a href='<?php echo $home_path; ?>/masters/frontoffice/submenu-category.php' ><span>M.I.S.</span></a></li>
			   <?php } ?>
			   
			  </ul>
   </li>
   
<li ><a href='#'>Point of Sale</a> 
<ul>
<?php
	  if(in_array('accou_receiv',$menuVals) || $_SESSION['user'] == 'admin' || $_SESSION['user'] == 'mani')
		{ ?>
         <li class='<?php echo $qt; ?>'><a href='<?php echo $home_path; ?>/transaction/frontdesk/open-outlet.php' >Outlets</a></li>
	<?php } ?>
	
       </ul>
   </li>
   
  <li><a href='#'>Banquets</a> 
   <ul>
	<?php   if(in_array('chkout_sumry',$menuVals) || $_SESSION['user'] == 'admin' || $_SESSION['user'] == 'mani'){  ?>
	<li class='<?php echo $qt; ?>'><a href='<?php echo $home_path; ?>/reports/checkout/outstanding_report.php' >Operations</a></li>
	<?php } ?>
	<?php if(in_array('roomadvrt_det',$menuVals) || $_SESSION['user'] == 'admin' || $_SESSION['user'] == 'mani') { ?>
	<li class='<?php /*echo $qt;*/ ?>'><a href='<?php echo $home_path; ?>/reports/checkout/ar_receipts_report.php' >Views</a></li>
	<?php } ?>	
	<?php   if(in_array('chkout_sumry',$menuVals) || $_SESSION['user'] == 'admin' || $_SESSION['user'] == 'mani'){  ?>
	<li class='<?php /*echo $qt;*/ ?>'><a href='#' >Reports</a></li>
	<?php } ?>	
	</ul>
	</li>
