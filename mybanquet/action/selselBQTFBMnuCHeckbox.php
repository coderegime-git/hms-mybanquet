...
/*$sqlt=mysql_query("select distinct item_code from bq_tempfp where temp_sts='set' AND bkNo='".$bkNo."' and itmsubmnu_code!=''");
while($row=mysql_fetch_array($sqlt)){
$sqlLk="UPDATE bq_tempfp SET ";
$sqlLk=$sqlLk."status='2'";
$sqlLk=$sqlLk." where item_code='".$row['item_code']."' AND bkNo='".$bkNo."'" ;
//echo $sqlLk;
$UsQLk =mysql_query($sqlLk);
}*/
