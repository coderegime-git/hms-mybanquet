...
$vucsts='';
	...
	$sql="insert into bq_opfpmenuhdr(fpno,fpdate,bkno,hallbook_id,bkdate,hallchrg,halltax,hallincl,hallchgnoincl,ratechrg,ratetax,rateincl,ratechgnoincl,arrtime,pictime,sertime,depinst,signboard,remarks,evetea,mortea,menu_code,bill_status,vuc_status,added_by,added_on)";
	$sql.=" values(";
	$sql.="'".$fpNum."',";
	$sql.="'".$curDate."',";
	$sql.="'".$_POST['booking_no']."',";
