...
$output.='<tr id="">
	<td style="text-align:center;" class="sourceonVAL"><input name="item_code[]" id="item_code1" type="text"  class="textbox fstChUPPRCase expet" style="width:100px;margin:5px 0 0 0px" value="'.$rowb['session'].'" readonly /></td>
	<td style="text-align:center;" class="sourceonVAL"><input name="item_name[]" id="item_name1" type="text"  class="textbox fstChUPPRCase expet" style="width:230px;margin:5px 0 0 0px" value="'.$roS['sess_name'].'" readonly /></td>
...
/* Start Advance */
$sqsC=mysql_query("select * from bq_hallresvadv where booking_no='".$row['bkno']."' AND status='1'");
