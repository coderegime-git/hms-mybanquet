...
if($UsQuery){
	header('location:'.$home_path.'/masters/banquet/tax_structure_bqt.php?msg=Data saved Successfully!');
}
else{
	header('location:'.$home_path.'/masters/banquet/tax_structure_bqt.php?msg=Error in insertion');
}
