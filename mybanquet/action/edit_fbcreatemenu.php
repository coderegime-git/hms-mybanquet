...
$sqlm=mysql_query("select * from bq_itemmaster where itmnu_code='".$menu."' AND status='1' AND itmsub_cat!='oth' ORDER BY itmsubmnu_code desc");
}
$j=1;
...
$output.='<tr id="">
	...
	<td style="text-align:center;" class="sourceonVAL"><input name="menusel[]" id="menusel" type="checkbox"  class="textbox fstChUPPRCase expet chk" style="width:52px;margin:5px 0 0 0px" value="'.$item_code.'" submenu="'.$submenu.'" onclick="setMenu(this);Menuselval(this.value);"  '.$ch.' />
