...
$output.='<td style="text-align:center;width:20px;background-color:'.$bgcolor.';color:#fff;" ><a href="'.$home_path.'/transaction/frontdesk/edit-hall-status.php?roomBk='.$roD['booking_no'].'&rmBkID='.$roD['hallbook_id'].'" data-toggle="tooltip" title="BK#:'.$roD['booking_no'].','.strtoupper('  GUEST:'.$roD['guest_name']).',  PAX: '.$sqb['guaranted'].'">&nbsp;</a></td>';
 }else{ 
