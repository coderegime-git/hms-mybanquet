...
<div id="addcustomer" class="frmCentr divBrd frmBgClr" style="width:700px;height:239px;">
	<h3 id="Userhd"><b>Import Menu Group</b></h3>
		<form class="form-horizontal well" action="upload_mnugrp.php" method="post" name="upload_excel" enctype="multipart/form-data">
