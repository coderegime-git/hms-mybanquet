...
$rBq=mysql_query("select sum(taxamt)as tx from bq_opvchrtaxdtl where vouchrno='".$VucNo."' group by taxcode");
$taxAamtt2=0;
...
$rBev=mysql_fetch_array(mysql_query("select sum(taxamt)as tx from bq_opvchrtaxdtl where vouchrno='".$VucNo."' AND bill_status!='3' and taxcode='BEV'"));
$taxAamtB=$rBev['tx'];
...
EOD;
echo "SELECT * FROM `bq_opvchrdtl` WHERE vouchrno = '".$VucNo."'";
...
<td style="width:15%;text-align:left;">123</td>
