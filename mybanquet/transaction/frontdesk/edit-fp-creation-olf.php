...
<?php 
$sqmnu=mysql_fetch_array(mysql_query("select menu_code from bq_opfpmenuhdr where bill_status='1'"));
 ?>		
	<tr>
	<td width="" valign="top"><label>Menu</label></td>
	<td valign="top">
	<select name="menu" id="menu" style="font-size:12px;width:210px" onload="selMenuCode();" class="wagRw1 textbox">
	<option value="">--Select--</option>
	<?php
	$sqle=mysql_query("select distinct menu_code,menu_name from bq_menumaster where status='1' AND menu_code!=''");
	while($res=mysql_fetch_array($sqle)){
	?>
	<option value="<?php echo $res['itmnu_code']  ?>"<?php echo ($sqmnu['menu_code']==$res['menu_code'])?'selected':''; ?> ><?php echo strtoupper($res['menu_name']); ?></option>
	<?php } ?>
	</select>
	</td>
	</tr>
...
<table style="border-left:1px solid #ddd;" class="table">
	...
	<div style="margin:0px 0 0 0px;">
		<button type="submit" id="send" name="send" class="butExample bnkSbt frstChr" style="" onclick="return checkformSubmit();"><img src="../../images/saves.png" class="sbtBtnImg frstChr"/>&nbsp;&nbsp;<span class="btnUndLine">U</span>pdate</button>
		
		<a href="view-fb-creation-chk.php"><button type="button" id="update" class="butExample bnkSbt" onclick="return checkPropertyMasterq();"><img src="../../images/audit.png" class="sbtBtnImg "/>&nbsp;&nbsp;<span class="btnUndLine">V</span>iew</button></a>
		...
		<a href="<?php echo $home_path; ?>/transaction/frontdesk/view-fb-creation-chk.php"><button type="button" id="exit" name="exit" class="butExample" style="" ><img src="../../images/exitBut.png" class="sbtBtnImg" />&nbsp;&nbsp;<span class="btnUndLine">E</span>xit</button></a>
