...
<tr>
	...
	<td valign="top"><input name="guest_name" id="guest_name" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" style="width:210px" value="<?php echo $rowb['guest_name'];?>" readonly /></td>
		...
		<td valign="top"><input name="tot_pax" id="tot_pax" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" value="<?php echo $rowb['guaranted'];?>" style="width:210px" /></td>
		</tr>
	...
	<select name="menu" id="menu" style="font-size:12px;width:210px" onChange="selMenuCode();" class="wagRw1 textbox">
			<option value="">--Select--</option>
			<?php
			/* $sqle=mysql_query("select distinct menu_code,menu_name from bq_menugrp where status='1'");
			while($res=mysql_fetch_array($sqle)){ */
			?>
...
?>
		<tr>
			...
			<input name="halltax_chg" id="halltax_chg" type="text" class="textbox fstChUPPRCase" style="width:60px;margin:0 0 0 -8px;" value='<?php echo $rowb['hall_rate']; ?>' />
...
<tr>
	...
	<th width="" style="text-align:center;background-color:#F5F5F5;font-size:12px;width:150px;">Preference</th>
</tr>
</thead>
...
?>
<tr id="">
	<td style="text-align:center;" class="sourceonVAL"><input name="item_code[]" id="item_code" type="text"  class="textbox fstChUPPRCase expet" style="width:100px;margin:5px 0 0 0px" value="" /></td>
	<td style="text-align:center;" class="sourceonVAL"><input name="item_name[]" id="item_name" type="text"  class="textbox fstChUPPRCase expet" style="width:230px;margin:5px 0 0 0px" value="" /></td>
	...
	<td style="text-align:center;" class="sourceonVAL"><input name="prefn[]" id="prefn<?php echo $cc;?>" type="text"  class="textbox fstChUPPRCase expet" style="width:150px;margin:5px 0 0 0px" value="" /></td>
</tr>	
<?php 
}
?>										
...
$x++;
?>
    <tr class="treegrid-<?php echo  $x;  ?> expanded"><td><?php echo strtoupper($row['itmsubmnu_code']); ?></td></tr>
	<?php 
...
<tr>
	<th width="" style="text-align:center;background-color:#F5F5F5;font-size:12px;width:221px;">Item name</th>
	...
	<th width="" style="text-align:center;background-color:#F5F5F5;font-size:12px;width:145px;">Preference</th>
...
?>
<tr id="">
	<td style="text-align:center;" class="sourceonVAL"><input name="open_itemname[]" id="open_itemname" type="text"  class="textbox fstChUPPRCase expet" style="width:210px;margin:5px 0 0 0px" value="" /></td>
	...
	<td style="text-align:center;" class="sourceonVAL"><input name="open_itempreference[]" id="open_itempreference" type="text"  class="textbox fstChUPPRCase expet" style="width:145px;margin:5px 0 0 0px" value="" /></td>
</tr>	
<?php 
}
?>	
