...
<div id="addcustomer" class="frmCentr divBrd frmBgClr" style="width:944px;">
...
<td valign="top">
<input name="booking_no" id="booking_no" type="text" class="textbox fstChUPPRCase" style="width:210px" data-toggle="modal" data-target="#myModal" onclick="fpBkn();" readonly />
<!--<select name="booking_no" id="booking_no" style="font-size:12px;width:80px;" data-validation="required" class="input validate[required] wagRw1 textbox" onChange="selBQTFBCreat();">
<option value="">--Select--</option>
<?php
$sqle=mysql_query("select distinct booking_no from bq_hallbooking where str_to_date(book_date,'%d/%m/%Y')>='$ctt' AND confirm_status='2' AND fp_status=''");
while($res=mysql_fetch_array($sqle)){
?>
<option value="<?php echo $res['booking_no']  ?>" ><?php echo strtoupper($res['booking_no']); ?></option>
<?php } ?>
</select><span style="float:left;font-size:12px;">&nbsp;Func Dt&nbsp;</span><input name="func_dt" id="func_dt" type="text" class="textbox fstChUPPRCase" style="width:82px" readonly />-->
</td>
</tr>
<tr>
...
<tr>
	...
	<td valign="top"><input name="guest_name" id="guest_name" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" style="width:210px" readonly /></td>
		...
		<td valign="top"><input name="tot_pax" id="tot_pax" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" style="width:210px" /></td>
		</tr>
...
<thead class="tathead">
<tr>
<td colspan="3"><h3 id="rmTyp" style="background-color:#0073B5;color:#fff;"><b>Menu Creation</b></h3></td>
</tr>
<tr>
...
<tr id="">
	...
	<td style="text-align:center;" class="sourceonVAL"><input name="item_name[]" id="item_name" type="text"  class="textbox fstChUPPRCase expet" style="width:200px;margin:5px 0 0 0px" value="" /></td>
...
<!--<div class="spacer menuDet" style="height:300px;overflow:auto;margin:10px 0 0 0;">
<ul id="zeroTree" class="">
<?php 
/* $sql=mysql_query("select * from bq_menugrp where status='1'");
while($row=mysql_fetch_array($sql)){ */
?>
<li style="color:#7B0E0E;font-weight:bold;font-size:11px;"><?php /* echo $row['menu_name']; */ ?>
	<ul>
		<li style="color:#7B0E0E;font-weight:bold;font-size:11px;"><?php /* echo $row['menu_name'];  */?></li>
	</ul>
</li>
<?php /* } */ ?>
</ul>
...
<div class="spacer menuDetShw" style="height:300px;overflow:auto;margin:10px 0 0 0;">
...
<tr>
	<th width="" style="text-align:center;background-color:#F5F5F5;font-size:12px;width:240px;">Item name</th>
...
?>
<tr id="">
	<td style="text-align:center;" class="sourceonVAL"><input name="open_itemname[]" id="open_itemname" type="text"  class="textbox fstChUPPRCase expet" style="width:240px;margin:5px 0 0 0px" value="" /></td>
	<td style="text-align:center;" class="sourceonVAL">
...
<table style="border-left:1px solid #ddd;" class="table">
	...
	<div style="margin:0px 0 0 0px;">
		...
		<a href="view-fb-creation.php?fromdate=<?php echo $rowAC['cur_date'];?>&todate=<?php echo $rowAC['cur_date'];?>&val="><button type="button" id="update" class="butExample bnkSbt" onclick="return checkPropertyMasterq();"><img src="../../images/audit.png" class="sbtBtnImg "/>&nbsp;&nbsp;<span class="btnUndLine">V</span>iew</button></a>
