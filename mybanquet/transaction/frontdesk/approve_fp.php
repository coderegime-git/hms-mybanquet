...
<!--<div id="addcustomer" class="frmCentr divBrd frmBgClr" style="width:1112px;overflow:auto;height:500px;">-->
	<h3 id="Userhd"><b>Approve Menu </b></h3>
<form id="hotelDefi" name="hotelDefi" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/update_approve_fp.php" method="post" class="" style="">
...
<tr>
	...
	<td valign="top"><input name="guest_name" id="guest_name" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" style="width:210px" value="<?php echo $rowb['guest_name'];?>" readonly /></td>
		...
		<td valign="top"><input name="tot_pax" id="tot_pax" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" value="<?php echo $rowb['guaranted'];?>" style="width:210px" readonly /></td>
		</tr>
<?php 
 ...
 ?>		
	...
	<tr>
		...
		<tr>
			...
			<td valign="top"><textarea cols="34" rows="2" name="remarks" id="remarks" value="" style="text-transform:uppercase;font-size:12px;" readonly><?php echo $sqmnh['remarks'];?></textarea></td>
		</tr>
		<tr>
				<td width="" valign="top"><label>Sign Board</label></td>
				<td valign="top"><textarea cols="34" rows="" name="sign_board" id="sign_board" value="" style="text-transform:uppercase;font-size:12px;margin:0px 0 0 0;" readonly><?php echo $sqmnh['signboard'];?></textarea></td>
		</tr>
<?php 
...
?>
		<tr>
			...
			<input name="halltax_chg" id="halltax_chg" type="text" class="textbox fstChUPPRCase" style="width:60px;margin:0 0 0 -8px;" value="<?php echo $sqmnh['hallchrg']; ?>" readonly />
		...
		<tr>
			...
			<input name="ratetax_chg" id="ratetax_chg" type="text" class="textbox fstChUPPRCase" style="width:60px;margin:0 0 0 0px;" value='<?php echo $sqmnh['ratechrg']; ?>' readonly />
...
<tr id="">
	...
	<td style="text-align:center;" class="sourceonVAL"><input name="prefn[]" id="prefn<?php echo $cc;?>" type="hidden"  class="textbox fstChUPPRCase expet" style="width:150px;margin:5px 0 0 0px" value="" /></td>
</tr>	
<?php 
}
?>										
...
?>
<tr id="">
	<td style="text-align:center;" class="sourceonVAL"><input name="open_itemname[]" id="open_itemname" type="text"  class="textbox fstChUPPRCase expet" style="width:210px;margin:5px 0 0 0px" value="<?php echo $rowm['itemname']; ?>" /></td>
	<td style="text-align:center;" class="sourceonVAL"><input name="open_itemrate[]" id="open_itemrate" type="text"  class="textbox fstChUPPRCase expet" style="width:80px;margin:5px 0 0 0px" value="<?php echo $rowm['rate']; ?>" /></td>
	<td style="text-align:center;" class="sourceonVAL">
	...
	<td style="text-align:center;" class="sourceonVAL"><input name="open_itempreference[]" id="open_itempreference" type="text"  class="textbox fstChUPPRCase expet" style="width:130px;margin:5px 0 0 0px" value="<?php echo $rowm['preference']; ?>" /></td>
</tr>	
<?php 
}
?>	
...
<div class="col-md-12  responsive nowrap " style=" padding-left:3px;">
		<button type="submit" id="send" name="send" class="btn btn-primary btn-sm btn-responsive" style="" onclick="return checkformSubmit();"><img src="../../images/saves.png" class="sbtBtnImg frstChr"/>&nbsp;&nbsp;<span class="btnUndLine">A</span>pprove</button>
