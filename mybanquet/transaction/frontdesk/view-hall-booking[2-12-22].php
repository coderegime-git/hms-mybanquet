...
$item_where= " where str_to_date(book_date,'%d/%m/%Y') >= '$cdate' and guest_name like '%".$_GET['val']."%' OR phone like '%".$_GET['val']."%' OR venue like '%".$_GET['val']."%' OR booking_no like '%".$_GET['val']."%' and log_status='1' order by str_to_date(book_date,'%d/%m/%Y') ASC";
