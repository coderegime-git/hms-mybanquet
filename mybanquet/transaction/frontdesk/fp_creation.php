...
?>
<tr id="">
	<td style="text-align:center;" class="sourceonVAL"><input name="open_itemname[]" id="open_itemname<?php echo $cc; ?>" type="text"  class="textbox fstChUPPRCase expet" style="width:287px;margin:5px 0 0 0px" value="" /></td>
