...
$(document).ready(function(){
    ...
    if(typeof shortcut !== 'undefined') {
        ...
        shortcut.add("Ctrl+V", function() { 
            window.location.href = "view-reservadvance.php";
        });
        shortcut.add("Ctrl+C", function() { 
            $('#taxTypes').find("input[type=text]:not([readonly]), textarea").val("");
        });
...
<div class="mypay-container">
    ...
    <div class="mypay-card">
        ...
        <form id="taxTypes" name="taxTypes" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_resv_adv_refund.php" method="post">
            <div class="mypay-card-body">
                <table class="mypay-form-table" cellpadding="0" cellspacing="0">
                    <tbody>
                        ...
                        <tr>
                            <td class="mypay-label-cell">
                                <label for="book_no">Booking No<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="book_no" id="book_no" class="mypay-input" value="<?php echo isset($rowR['booking_no']) ? htmlspecialchars($rowR['booking_no']) : ''; ?>" readonly />
                            </td>
                        </tr>

                        <tr>
                            <td class="mypay-label-cell">
                                <label for="receipt_no">Receipt No<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="receipt_no" id="receipt_no" class="mypay-input" value="<?php echo isset($rowR['receipt_no']) ? htmlspecialchars($rowR['receipt_no']) : ''; ?>" readonly />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="guest_name" id="guest_name" class="mypay-input" value="<?php echo isset($rowR['guest_name']) ? htmlspecialchars($rowR['guest_name']) : ''; ?>" readonly />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <input type="text" name="amount" id="amount" class="mypay-input" value="<?php echo isset($_GET['rmAmt']) ? htmlspecialchars($_GET['rmAmt']) : ''; ?>" readonly />
                            </td>
                        </tr>

                        <tr>
                            <td class="mypay-label-cell">
                                <label for="ref_amt">Refund Amount<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="ref_amt" id="ref_amt" class="mypay-input" placeholder="0.00" required />
                            </td>
                        </tr>

                        <tr>
                            <td class="mypay-label-cell">
                                <label for="ret_amt">Retention<span class="req-star">*</span> :</label>
                            </td>
                            <td class="mypay-input-cell">
                                <input type="text" name="ret_amt" id="ret_amt" class="mypay-input" placeholder="0.00" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="mypay-input-cell">
                                <select name="card_desc" id="card_desc" class="mypay-input" disabled>
                                    <option value="">--Select--</option>
                                    <?php 
            ...
            <div class="mypay-card-footer">
                ...
                <a href="view-reservadvance.php" class="btn-mypay-action" title="View (Ctrl+V)">
