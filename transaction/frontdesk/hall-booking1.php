...
<input name="guest_name" id="guest_name" type="text" data-validation="required" class="input validate[required] textbox fstChUPPRCase" style="width:160px" placeholder="Name"/>
					...
					<td valign="top"><input name="address1" id="address1" type="text" data-validation="required" class="input validate[required] fstChUPPRCase textbox"  style="width:210px"/></td>
					</tr>
					<tr>
...
<tr>
	...
	<tr>
		...
		<td width="" valign="top">
<input name="phone" type="text" id="mobile" class="input validate[required,custom[integer],minSize[10],maxSize[10]] textbox fstChUPPRCase" maxlength="10" pattern="\d{10}" style="width:210px"  onkeypress="return pointNum(event);"/>
</td>
	</tr>
	<tr>
...
<table style="border-left:1px solid #ddd;" class="table">
	...
	<div style="margin:0px 0 0 0px;">
		...
		<a href="view-hall-booking.php?fromdate=<?php echo $rowAC['cur_date'];?>&todate=<?php echo $rowAC['cur_date'];?>&val="><button type="button" id="update" class="butExample bnkSbt" onclick="return checkPropertyMasterq();"><img src="../../images/audit.png" class="sbtBtnImg "/>&nbsp;&nbsp;<span class="btnUndLine">V</span>iew</button></a>
