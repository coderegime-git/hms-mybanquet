...
<thead class="tathead">
	<tr>
		...
		<th width="" style="text-align:center;background-color:#F5F5F5;color:#000;width:85px;">Rate</th>
		<th width="" style="text-align:center;background-color:#F5F5F5;color:#000;width:87px;">Status</th>
		<th width="" style="text-align:center;background-color:#F5F5F5;color:#000;width:120px;">Guest</th>
...
<!-- End Room Status -->
<?php
$sqb=mysql_query("select * from bq_hallbooking where booking_no='".$_GET['roomBk']."' AND confirm_status!='7'");
...
<table style="border-left:1px solid #ddd;" class="table">
	...
	<div style="margin:0px 0 0 0px;">
		...
		<a href="view-hall-booking.php"><button type="button" id="update" class="butExample bnkSbt" onclick="return checkPropertyMasterq();"><img src="../../images/audit.png" class="sbtBtnImg "/>&nbsp;&nbsp;<span class="btnUndLine">V</span>iew</button></a>
		...
		<!--<a href="view-hallbook-status.php?fromdate=<?php echo $rowAC['cur_date'];?>&todate=<?php echo $rowAC['cur_date'];?>" target="_blank"><button type="button" id="hallsts" class="butExample" style="" onclick="hall_sts()"><img src="../../images/clear-icon.png" class="sbtBtnImg" style="width:20px;height:20px;" />&nbsp;&nbsp;<span class="btnUndLine">H</span>all Status</button></a>-->
			...
			<a href="<?php echo $home_path; ?>/dashboard.php?fromdate=<?php echo $rowAC['cur_date'];?>&todate=<?php echo $rowAC['cur_date'];?>" target="_blank"><button type="button" id="hallsts" class="butExample" style="" onclick="hall_sts()"><img src="../../images/clear-icon.png" class="sbtBtnImg" style="width:20px;height:20px;" />&nbsp;&nbsp;<span class="btnUndLine">H</span>all Status</button></a>
		...
		<a href="<?php echo $home_path; ?>/dashboard.php?fromdate=<?php echo $rowAC['cur_date'];?>&todate=<?php echo $rowAC['cur_date'];?>"><button type="button" id="exit" name="exit" class="butExample" style=""  ><img src="../../images/exitBut.png" class="sbtBtnImg" />&nbsp;&nbsp;<span class="btnUndLine">E</span>xit</button></a>
	</div>
	</td>
	</tr>
</table>		
