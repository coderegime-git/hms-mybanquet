...
<div id="addcustomer" style="border:1px solid #ddd;width:769px;height:335px;background-color:#17C464;">
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#d3524e;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Resettlement</b></h3>
<form id="hotelDefi" name="hotelDefi" enctype="multipart/form-data" action="<?php echo $home_path;?>/action/add_bqtREsettlement.php" method="post" class="" style="">
		<div>
...
$sqlBh=mysql_query("select * from bq_opbillstldtl where bill_no='".$_GET['blNo']."'");
$rowBh=mysql_fetch_array($sqlBh); 

$sqlb=mysql_query("select * from bq_hallbooking where booking_no='".$rowBh['bkno']."'");
...
?>		
<table style="float:left;width:100%;margin:4px 0 0 0;font-size:12px;" cellpadding="0" cellspacing="0" class="" border="0" >
<tbody>
<tr>
		<td width="60" valign="top"><label style="float:right;width:65px;margin:0 0 0 6px;color:#fff;font-weight:bold;">Bill #<em></em></label></td>
		<td valign="top" style="margin:0 0 0 0;">
		<input name="blno" id="blno" type="text" data-validation="required" class="input validate[required]  fstChUPPRCase inptSt" style="width:138px;" value="<?php echo $rowBh['bill_no']; ?>" readonly />
		<input name="bill_date" id="bill_date" type="hidden" data-validation="required" class="input validate[required]  fstChUPPRCase inptSt" style="width:82px;" value="<?php echo $rowBh['bill_date']; ?>" readonly />
		</td>
		<td width="60" valign="top"><label style="float:right;width:84px;margin:0 0 0 6px;color:#fff;font-weight:bold;">Bill Amount<em></em></label></td>
		<td valign="top" style="margin:0 0 0 0;">
		<input name="bill_amt" id="bill_amt" type="text" data-validation="required" class="input validate[required]  fstChUPPRCase inptSt" style="width:138px;" value="<?php echo $rowBh['billamt']; ?>" readonly />
		</td>
		<td width="60" valign="top"><label style="float:right;width:55px;margin:0 0 0 6px;color:#fff;font-weight:bold;">Balance <em></em></label></td>
		<td valign="top" style="margin:0 0 0 0;">
		<input name="balance" id="balance" type="text" class="fstChUPPRCase inptSt" style="width:87px;" value="<?php echo '0'; ?>" readonly />
		</td>
		<td width="60" valign="top"><label style="float:left;width:41px;margin:0 0 0 6px;color:#fff;font-weight:bold;">Mode<em></em></label></td>
		<td valign="top" style="margin:0 0 0 0;">
		<input name="pay_mode" id="pay_mode" type="text" data-validation="required" class="input validate[required]  fstChUPPRCase inptSt" style="width:87px;" value="<?php echo $rowb['pay_mode']; ?>"readonly />
		</td>
	</tr>	
	<tr>
		<td width="60" valign="top"><label style="float:right;width:65px;margin:0 0 0 6px;color:#fff;font-weight:bold;">FP #<em></em></label></td>
		<td valign="top" style="margin:0 0 0 0;">
		<input name="fp_no" id="fp_no" data-validation="required" class="input validate[required] textbox codesUPPERCase inptSt" style="width:82px;" value="<?php echo $rowBh['fpno']; ?>" onkeyup="getGUestName();" readonly />
		</td>
		<td width="60" valign="top"><label style="float:right;width:84px;margin:0 0 0 6px;color:#fff;font-weight:bold;">Guest Name<em></em></label></td>
		<td valign="top" style="margin:0 0 0 0;">
		<input name="guest_name" id="guest_name" type="text" data-validation="required" class="input validate[required]  fstChUPPRCase inptSt" style="width:138px;" value="<?php echo $rowb['guest_name']; ?>" readonly />
		</td>
		<td width="60" valign="top"><label style="float:right;width:55px;margin:0 0 0 6px;color:#fff;font-weight:bold;">Company <em></em></label></td>
		<td valign="top" style="margin:0 0 0 0;">
		<input name="comp_name" id="comp_name" type="text" class="fstChUPPRCase inptSt" style="width:87px;" value="<?php echo $rowb['company_name']; ?>" readonly />
		</td>
		<td width="60" valign="top"><label style="float:right;width:65px;margin:0 0 0 6px;color:#fff;font-weight:bold;">Book #<em></em></label></td>
<td valign="top" style="margin:0 0 0 0;">
<input name="bk_no" id="bk_no" type="text" data-validation="required" class="input validate[required]  fstChUPPRCase inptSt" style="width:87px;" value="<?php echo $rowBh['bkno']; ?>" readonly />
</td>
...
<tr>
<th width="" style="text-align:center;background-color:#d3524e;color:#fff;width:1%;">Mode</th>
</tr>
<tr>
<td>
...
<table cellpadding="0" cellspacing="0" border="1" class="" style="text-align:center;font-size:12px;width:100%;background-color:#fff;">
	<tr>
		<th width="" style="text-align:center;background-color:#d3524e;color:#fff;width:20%;">Amount</th>
		<th width="" style="text-align:center;background-color:#d3524e;color:#fff;width:16%;">Description</th>
		<th width="" style="text-align:center;background-color:#d3524e;color:#fff;width:16%;">Tips</th>
		<th width="" style="text-align:center;background-color:#d3524e;color:#fff;width:30%;">Remarks</th>
	</tr>
	<?php /* for($i=0;$i<5;$i++) { */?>
	<tr>
		<td width="" style="text-align:center;background-color:#ffffff;width:20%;height:31px;"><input name="cashrcd_amt" id="cashrcd_amt" type="text"  style="width:90px;border:1px solid #ddd;text-align:right;" value="<?php if(isset($rowBh['cash'])){echo $rowBh['cash'];}else{echo '0';}?>" class="inptSt amtBal"/></td>
	...
	<?php /* } */ ?>
	<tr>
		<td width="" style="text-align:center;background-color:#ffffff;width:20%;height:31px;"><input name="cardrcd_amt" id="cardrcd_amt" type="text"  style="width:90px;border:1px solid #ddd;text-align:right;" value="<?php if(isset($rowBh['card'])){echo $rowBh['card'];}else{echo '0';}?>" class="inptSt amtBal"/></td>
	...
	<tr>
		<td width="" style="text-align:center;background-color:#ffffff;width:20%;height:31px;"><input name="comprcd_amt" id="comprcd_amt" type="text"  style="width:90px;border:1px solid #ddd;text-align:right;" value="<?php if(isset($rowBh['company'])){echo $rowBh['company'];}else{echo '0';}?>" class="inptSt amtBal"/></td>
	
		<td width="" style="text-align:center;background-color:#ffffff;width:16%;height:31px;">
		<?php
		$sqlBS=mysql_query("select distinct comp_code,comp_name from company_master where  classf IN('company','travelagent','individual')  and status='1' order by comp_name ASC");
		/* $sqlBS=mysql_query("select distinct comp_code,comp_name from company_master where  classf='company' OR classf='travelagent' order by comp_name ASC"); */
		?>
	...
	<tr>
		<td width="" style="text-align:center;background-color:#ffffff;width:20%;height:31px;"><input name="chequercd_amt" id="chequercd_amt" type="text"  style="width:90px;border:1px solid #ddd;text-align:right;" value="<?php if(isset($rowBh['cheque'])){echo $rowBh['cheque'];}else{echo '0';}?>" class="inptSt amtBal"/></td>
	...
	<tr>
		<td width="" style="text-align:center;background-color:#ffffff;width:20%;height:31px;"><input name="neftrcd_amt" id="neftrcd_amt" type="text"  style="width:90px;border:1px solid #ddd;text-align:right;" value="<?php if(isset($rowBh['neft'])){echo $rowBh['neft'];}else{echo '0';}?>" class="inptSt amtBal"/></td>
	...
	<tr>
		<td width="" style="text-align:center;background-color:#ffffff;width:20%;height:31px;"><input name="roomrcd_amt" id="roomrcd_amt" type="text"  style="width:90px;border:1px solid #ddd;text-align:right;" value="<?php if(isset($rowBh['room'])){echo $rowBh['room'];}else{echo '0';}?>" class="inptSt amtBal"/></td>
		<td width="" style="text-align:center;background-color:#ffffff;width:16%;height:31px;">
		<select name="room_desc" id="room_desc" style="width:90px;border:1px solid #ddd;" class="inptSt" onChange="selRoomNo();" disabled >
		<option value="">--Select--</option>
		<?php 
		$sqlF=mysql_query("select distinct room_no from guest_register where room_no!='".$rowBh['room_no']."' AND bill_status='1' AND room_no!='' order by room_no ASC");
		while($rowF=mysql_fetch_array($sqlF)) {
				$sqR=mysql_query("select * from guest_register where room_no='".$rowF['room_no']."' AND bill_status='1'");
				$roR=mysql_fetch_array($sqR);
		?>
		<option value="<?php echo $rowF['room_no']; ?>"><?php echo $rowF['room_no'].' - '.strtoupper($roR['guest_name']); ?></option>
		<?php }	?>
		</select>
	...
	<tr>
		<td width="" style="text-align:center;background-color:#ffffff;width:20%;height:31px;"><input name="refundrcd_amt" id="refundrcd_amt" type="text" style="width:90px;border:1px solid #ddd;text-align:right;" value="<?php if(isset($rowBh['refund'])){echo $rowBh['refund'];}else{echo '0';}?>" class="inptSt amtBal" disabled /></td>
	...
	<tr>
		<td width="" style="text-align:center;background-color:#ffffff;width:20%;height:31px;"><input name="voidrcd_amt" id="voidrcd_amt" type="text" style="width:90px;border:1px solid #ddd;text-align:right;" value="<?php if(isset($rowBh['void'])){echo $rowBh['void'];}else{echo '0';}?>" class="inptSt amtBal"  /></td>
...
<tr>
	...
	<div style= "/*margin:0px 0 0 125px; */ text-align:center;margin:0px 0;">
		<button type="submit" id="confirm" class="butExample bnkSbt frstChr" style="" onclick="return formSubmit();"  ><img src="../../images/saves.png" class="sbtBtnImg frstChr"/>&nbsp;&nbsp;<span class="btnUndLine">S</span>ubmit</button>
		
		<a href="<?php echo $home_path; ?>/transaction/frontdesk/view-resettlement.php"><button type="button" id="confirm" class="butExample bnkSbt frstChr" style="" ><img src="../../images/saves.png" class="sbtBtnImg frstChr"/>&nbsp;&nbsp;<span class="btnUndLine">R</span>e-settle</button></a>	
		
		<button type="reset" id="rest" class="butExample bnkSbt frstChr" style=""><img src="../../images/clear.png" class="sbtBtnImg frstChr"/>&nbsp;&nbsp;<span class="btnUndLine">C</span>lear</button>
