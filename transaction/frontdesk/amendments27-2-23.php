...
<td width="" valign="top"><label>GST <em>*</em></label></td>
<td width="" valign="top">
<input name="amd_gst" type="text" id="amd_gst" class="input validate[required,custom[integer],minSize[10],maxSize[10]] textbox fstChUPPRCase" maxlength="10" pattern="\d{10}" style="width:210px"  onkeypress="return pointNum(event);"/>
</td>
</tr>
