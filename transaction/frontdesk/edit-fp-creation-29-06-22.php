...
$sqmnu=mysql_fetch_array(mysql_query("select menu_code from bq_opfpmenuhdr where fpno='".$_GET['fpNo']."' and bill_status='1'"));
 ?>		
	...
	<tr>
							...
							<td valign="top">
							<?php $sqlBS=mysql_query("select distinct menu_code,menu_name from bq_menumaster where status='1' AND menu_code!=''");?>
							...
							<?php if($rowBS['menu_code']==$sqmnu['menu_code']) { ?>
							<option value="<?php echo $rowBS['menu_code'];?>" selected ><?php echo $rowBS['menu_name'];?></option>
							<?php } else { ?>
							<option value="<?php echo $rowBS['menu_code'];?>"><?php echo $rowBS['menu_name'];?></option>
							<?php } } ?>
							</select>
							</td>
						</tr>
...
?>
		<tr>
			...
			<input name="halltax_chg" id="halltax_chg" type="text" class="textbox fstChUPPRCase" style="width:60px;margin:0 0 0 -8px;" value="<?php echo $sqmnh['hallchrg']; ?>" />
		...
		<tr>
			...
			<input name="ratetax_chg" id="ratetax_chg" type="text" class="textbox fstChUPPRCase" style="width:60px;margin:0 0 0 0px;" value='<?php echo $sqmnh['ratechrg']; ?>'/>
