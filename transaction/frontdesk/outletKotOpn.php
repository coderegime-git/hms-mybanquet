...
<tbody>
<?php $sqlRt=mysql_query("select table_no from pos_tablemaster");?>
<?php while($rowRt=mysql_fetch_array($sqlRt)){ ?>
<tr>
	<td valign="top" style="width:200px;"><input type="text" name="outlet_name" id="outlet_name" value="<?php echo $rowRt['table_no'];?>" class="buttExaSS" style="width:55px;border:none;" readonly /></td>
	...
	<td valign="top"><input type="button" name="openL" id="openL" value="Open" class="buttExaSS" style="width:55px;" onclick="SetName('<?php echo $rowRt['table_no'];?>');"/></td>
</tr>
<?php } ?>
</tbody>
</table>