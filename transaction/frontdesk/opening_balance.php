...
<div id="addcustomer" class="frmCentr divBrd" style="width:468px;">
	<h3 style="text-align:center;font-size:14px;padding:10px;background:#0080C0;color:#fff;margin:1px 0 0 0;text-transform:uppercase;"><b>Opening Balance</b></h3>
		<form id="taxTypes" name="taxTypes" enctype="multipart/form-data"  action="<?php echo $home_path;?>/action/add_ar_bills.php" method="post" class="" style="">
		<div>
			...
			<tbody>
					<tr>
						...
						<td valign="top"><input type="text" name="cur_date" id="cur_date" data-validation="required" class="input validate[required] codesUPPERCase curDate" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td valign="top"><input type="text" name="bill_date" id="bill_date" data-validation="required" class="input validate[required] fstChUPPRCase datepicker" onblur="checkBusinessDesc();"/></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>Bill Number<em>*</em></label></td>
						<td valign="top"><input type="text" name="bill_no" id="bill_no" data-validation="required" class="input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>Bill Amount<em>*</em></label></td>
						<td valign="top"><input type="text" name="bill_amount" id="bill_amount" data-validation="required" class="input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
						
					</tr>
					<tr>
						<td width="" valign="top"><label>Remarks<em>*</em></label></td>
						<td valign="top"><input type="text" name="remarks" id="remarks" data-validation="required" class="input validate[required] fstChUPPRCase" onblur="checkBusinessDesc();"/></td>
