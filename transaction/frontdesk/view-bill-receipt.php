...
<table class="table table-condensed table-hover table-striped table-bordered" cellpadding="0" cellspacing="0" border="0" class="table" style="margin:0 0 15px -5px;text-align:center;font-size:12px;">
	...
	<tr>
		...
		<th width="80" style="text-align:center;background-color:#F5F5F5;">Particulars</th>
		<th width="80" style="text-align:center;background-color:#F5F5F5;">Patch</th>
	...
	<?php 
$sql=mysql_query("select * from bill_detail group by bill_no order by bill_no ASC");
	...
	<tr>
		...
		<td width="80" class="fstChUPPRCase"><?php echo $row['particulars']; ?></td>
		<td width="80" class="fstChUPPRCase"><?php echo $row['patch']; ?></td>
		<td width="80" class="fstChUPPRCase"><?php echo $row['qty']; ?></td>
		<td width="80" class="fstChUPPRCase"><?php echo $row['rate']; ?></td>
	...
	<div style="margin: 21px 0 26px 10px;;width:95%;" class="alert alert-success">
                               You have not bill receipt out details...
    </div>
<?php } ?>
</table>
	</div>
