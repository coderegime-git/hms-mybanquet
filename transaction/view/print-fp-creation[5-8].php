...
EOD;
$tbl = <<<EOD
<table style="width:100%;text-align:left;line-height:15px;font-size:11px;font-weight:700px;"> 
<tr>
<td style="width:100%;border-collopse:collapse;"><b>PROPOSED MENU FOR $guest_name</b></td>
</tr>
EOD;
...
<tr>
<td style="width:50%;border-collopse:collapse;padding: 2px;"><b>SIGNBOARD</b></td>
<td style="width:50%;border-collopse:collapse;padding: 2px;">$sign</td>
</tr>
</table>
...
<tr>
<td style="width:50%;border-collopse:collapse;"></td>
<td style="width:50%;border-collopse:collapse;padding: 2px;">$wT</td>
</tr>
EOD;
} 
 } 
...
while($roop=mysql_fetch_array($sqop)){
	...
	$item=strtoupper($roop['itemname'].' - '.$roop['qty'].' ('.$roop['preference'].')');
	$tbl.=<<<EOD
<table style="font-size:11px;width:100%;padding-bottom:3px;">
<tr style="">
<td style="width:25%;border-collopse:collapse;"></td>
...
<tr>
<td style="width:15%;border-collopse:collapse;padding: 2px;border: 1px solid black;text-align:center;">MENU A</td>
...
<td style="width:15%;border-collopse:collapse;padding: 2px;border: 1px solid black;text-align:right;">$Tpax</td>
</tr>
EOD;
...
<td style="width:15%;border-collopse:collapse;padding: 2px;border: 1px solid black;text-align:right;">$Ggtot</td>
</tr>
EOD;
$tax=$Ggtot*18/100;
$gst=sprintf("%01.2f",$tax/2);
$net=sprintf("%01.2f",$Ggtot+$tax);
$tbl.=<<<EOD
<tr>
<td style="width:15%;border-collopse:collapse;padding: 2px;border: none;text-align:center;"></td>
<td style="width:25%;border-collopse:collapse;padding: 2px;border: none;text-align:left;"></td>
