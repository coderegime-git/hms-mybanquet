...
$adv=sprintf("%01.2f",$sign.$tt);
 ...
 $sqlr = mysql_fetch_array(mysql_query("SELECT * FROM bq_opvchrtaxdtl where vouchrno = '".$_GET['vuNum']."' and  bill_status != '3'"));
 $sqlrr = mysql_fetch_array(mysql_query("SELECT * FROM bq_taxstruct where str_code = 'food5' and status='1'"));
