...
/*$sqlr = mysql_fetch_array(mysql_query("SELECT count(*) as rt FROM hms_parameters where description = 'Enable Tax Percentage' and module_name = 'Banquets' and status = '1'"));
 if($sqlr['rt'] == '1'){
	 $pSgSt = 'SGST';
	 $PCgst = 'CGST';
 ...
 $sqlr = mysql_fetch_array(mysql_query("SELECT * FROM bq_opbilltaxdtl where billno = '".$blN."' and bill_status='1'"));
 $sqlrr = mysql_fetch_array(mysql_query("SELECT * FROM bq_taxstruct where str_code = '".$sqlr['taxstruccode']."' and status='1'"));

 $pSgSt = 'SGST '.$sqlrr['factor_value'];
 $PCgst = 'CGST '.$sqlrr['factor_value'];
$html.='
</table>
</td>
<td style="width:33%;">
...
<tr>
<td style="text-align:right;">'.$PCgst.'</td>
<td style="text-align:right;">'.$taxAamtt2.'</td>
</tr>
<tr>
<td style="text-align:right;">'.$pSgSt.'</td>
<td style="text-align:right;">'.$taxAamtt2.'</td>
</tr>
<!--<tr>
