...
$roc=mysql_fetch_array($suc);
	...
	$sql="insert into bq_opfpmenudetail(fpno,fpdate,sac,itemcode,itemname,qty,rate,preference,taxstructcode,submenugrpcode,menugrpcode, 	menucode,subcatcode,catcode,grpcode,bill_status)";
	$sql.=" values(";
	$sql.="'".$fpNum."',";
	$sql.="'".$curDate."',";
	$sql.="'".$_POST['open_sac'][$co]."',";
	$sql.="'".$opitmCde."',";
