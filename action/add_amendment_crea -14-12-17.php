...
if(isset($_POST['author_by'])){
	...
	$author_by="";
		...
		$sql.="'".$_POST['amd_grpx']."',";
		$sql.="'".$_POST['amd_expx']."',";
		$sql.="'".$_POST['amd_halldet']."',";
		$sql.="'".$_POST['amd_hallchg']."',";
		$sql.="'".$_POST['amd_hallincl']."',";
		$sql.="'".$amd_halltxincl."',";
		$sql.="'".$_POST['amd_ratetax_det']."',";
...
$vucsts='';
	...
	$sql="insert into bq_opfpmenuhdr(fpno,fpdate,bkno,hallbook_id,bkdate,hallchrg,halltax,hallincl,hallchgnoincl,ratechrg,ratetax,rateincl,ratechgnoincl,arrtime,pictime,sertime,depinst,signboard,remarks,evetea,mortea,menu_code,grpax,exppax,bill_status,vuc_status,added_by,added_on)";
	$sql.=" values(";
	$sql.="'".$fpNum."',";
	$sql.="'".$curDate."',";
	$sql.="'".$_POST['booking_no']."',";
...
for($co=0;$co<count($open_itemname);$co++){
...
/* echo $sql; */
	mysql_query($sql);
	 ...
	 /* echo "select * from bq_opfpmenudetail where fpno='".$_POST['fp_no']."' AND itemcode='55555'";
	 die(); */
