...
if(mysql_num_rows($sqM)==0){
	...
	if($_POST['from_time'][$cc]!=''){
		...
		for($sT=$str;$sT<=$enr;$sT++){
			if($sT=='06'){$tmS6=$_POST['confirm_status'][$cc];}
				if($sT=='07'){$tmS7=$_POST['confirm_status'][$cc];}
				if($sT=='08'){$tmS8=$_POST['confirm_status'][$cc];}
				if($sT=='09'){$tmS9=$_POST['confirm_status'][$cc];}
				if($sT=='10'){$tmS10=$_POST['confirm_status'][$cc];}
				if($sT=='11'){$tmS11=$_POST['confirm_status'][$cc];}
				if($sT=='12'){$tmS12=$_POST['confirm_status'][$cc];}
				if($sT=='13'){$tmS13=$_POST['confirm_status'][$cc];}
				if($sT=='14'){$tmS14=$_POST['confirm_status'][$cc];}
				if($sT=='15'){$tmS15=$_POST['confirm_status'][$cc];}
				if($sT=='16'){$tmS16=$_POST['confirm_status'][$cc];}
				if($sT=='17'){$tmS17=$_POST['confirm_status'][$cc];}
				if($sT=='18'){$tmS18=$_POST['confirm_status'][$cc];}
				if($sT=='19'){$tmS19=$_POST['confirm_status'][$cc];}
				if($sT=='20'){$tmS20=$_POST['confirm_status'][$cc];}
				if($sT=='21'){$tmS21=$_POST['confirm_status'][$cc];}
				if($sT=='22'){$tmS22=$_POST['confirm_status'][$cc];}
				if($sT=='23'){$tmS23=$_POST['confirm_status'][$cc];}
				if($sT=='24'){$tmS24=$_POST['confirm_status'][$cc];}
			if($sT==$str){
...
$dash_id=$rwM['dash_id'];
						...
						if($sT=='06'){$tmS6=$_POST['confirm_status'][$cc];}else{$tmS6=$rwM['tme6'];}
						if($sT=='07'){$tmS7=$_POST['confirm_status'][$cc];}else{$tmS7=$rwM['tme7'];}
						if($sT=='08'){$tmS8=$_POST['confirm_status'][$cc];}else{$tmS8=$rwM['tme8'];}
						if($sT=='09'){$tmS9=$_POST['confirm_status'][$cc];}else{$tmS9=$rwM['tme9'];}
						if($sT=='10'){$tmS10=$_POST['confirm_status'][$cc];}else{$tmS10=$rwM['tme10'];}
						if($sT=='11'){$tmS11=$_POST['confirm_status'][$cc];}else{$tmS11=$rwM['tme11'];}
						if($sT=='12'){$tmS12=$_POST['confirm_status'][$cc];}else{$tmS12=$rwM['tme12'];}
						if($sT=='13'){$tmS13=$_POST['confirm_status'][$cc];}else{$tmS13=$rwM['tme13'];}
						if($sT=='14'){$tmS14=$_POST['confirm_status'][$cc];}else{$tmS14=$rwM['tme14'];}
						if($sT=='15'){$tmS15=$_POST['confirm_status'][$cc];}else{$tmS15=$rwM['tme15'];}
						if($sT=='16'){$tmS16=$_POST['confirm_status'][$cc];}else{$tmS16=$rwM['tme16'];}
						if($sT=='17'){$tmS17=$_POST['confirm_status'][$cc];}else{$tmS17=$rwM['tme17'];}
						if($sT=='18'){$tmS18=$_POST['confirm_status'][$cc];}else{$tmS18=$rwM['tme18'];}
						if($sT=='19'){$tmS19=$_POST['confirm_status'][$cc];}else{$tmS19=$rwM['tme19'];}
						if($sT=='20'){$tmS20=$_POST['confirm_status'][$cc];}else{$tmS20=$rwM['tme20'];}
						if($sT=='21'){$tmS21=$_POST['confirm_status'][$cc];}else{$tmS21=$rwM['tme21'];}
						if($sT=='22'){$tmS22=$_POST['confirm_status'][$cc];}else{$tmS22=$rwM['tme22'];}
						if($sT=='23'){$tmS23=$_POST['confirm_status'][$cc];}else{$tmS23=$rwM['tme23'];}
						if($sT=='24'){$tmS24=$_POST['confirm_status'][$cc];}else{$tmS24=$rwM['tme24'];}
...
for( $cc=0; $cc<count($book_date); $cc++ ){
	if($_POST['book_date'][$cc]!=''){
		$adv="";
		$sqlAR="insert into  bq_hallbooking(audit_date,book_date,booking_no,venue,session,from_time,to_time,seating,funct,expected,guaranted,hall_rate,confirm_status,chief_guest,corporate,title,guest_name,address1,address2,city,country,phone,email,company_name,comaddress1,comaddress2,comcity,comphone,comemail,booker_name,booker_no,top_code,business_src,segment_code,purpose_visit,pay_mode,remarks,adv,added_by,added_on)";
		$sqlAR.=" values(";
		$sqlAR.="'".$curDate."',";
		$sqlAR.="'".$_POST['book_date'][$cc]."',";
		$sqlAR.="'".$bookNum."',";
